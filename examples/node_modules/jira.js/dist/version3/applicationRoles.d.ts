...
export declare class ApplicationRoles {
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getApplicationRole<T = Models.ApplicationRole>(parameters: Parameters.GetApplicationRole | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns an application role.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getApplicationRole<T = Models.ApplicationRole>(parameters: Parameters.GetApplicationRole | string, callback?: never): Promise<T>;
}
