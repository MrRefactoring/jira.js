...
export declare class JqlFunctionsApps {
    private client;
     ...
     */
    getPrecomputations<T = Models.PageJqlFunctionPrecomputation>(parameters: Parameters.GetPrecomputations | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns the list of a function's precomputations along with information about when they were created, updated, and
     * last used. Each precomputation has a `value` - the JQL fragment to replace the custom function clause with.
     *
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    getPrecomputations<T = Models.PageJqlFunctionPrecomputation>(parameters?: Parameters.GetPrecomputations, callback?: never): Promise<T>;
    /**
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    updatePrecomputations<T = void>(parameters: Parameters.UpdatePrecomputations, callback: Callback<T>): Promise<void>;
    /**
     * Update the precomputation value of a function created by a Forge/Connect app.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** An API
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    updatePrecomputations<T = void>(parameters: Parameters.UpdatePrecomputations, callback?: never): Promise<T>;
    /**
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    getPrecomputationsByID<T = Models.JqlFunctionPrecomputationGetByIdResponse>(parameters: Parameters.GetPrecomputationsByID, callback: Callback<T>): Promise<void>;
    /**
     * Returns function precomputations by IDs, along with information about when they were created, updated, and last
     * used. Each precomputation has a `value` - the JQL fragment to replace the custom function clause with.
     *
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    getPrecomputationsByID<T = Models.JqlFunctionPrecomputationGetByIdResponse>(parameters: Parameters.GetPrecomputationsByID, callback?: never): Promise<T>;
}
