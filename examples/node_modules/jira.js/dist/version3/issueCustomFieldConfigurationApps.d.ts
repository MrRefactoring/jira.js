...
export declare class IssueCustomFieldConfigurationApps {
     ...
     */
    getCustomFieldsConfigurations<T = Models.PageBulkContextualConfiguration>(parameters: Parameters.GetCustomFieldsConfigurations | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     * configurations for list of custom fields of a
     * [type](https://developer.atlassian.com/platform/forge/manifest-reference/modules/jira-custom-field-type/) created
     ...
     * for the Forge app that provided the custom field type.
     */
    getCustomFieldsConfigurations<T = Models.PageBulkContextualConfiguration>(parameters?: Parameters.GetCustomFieldsConfigurations, callback?: never): Promise<T>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     ...
     * for the Forge app that provided the custom field type.
     */
    getCustomFieldConfiguration<T = Models.PageContextualConfiguration>(parameters: Parameters.GetCustomFieldConfiguration | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     * configurations for a custom field of a
     * [type](https://developer.atlassian.com/platform/forge/manifest-reference/modules/jira-custom-field-type/) created
     ...
     * for the Forge app that provided the custom field type.
     */
    getCustomFieldConfiguration<T = Models.PageContextualConfiguration>(parameters: Parameters.GetCustomFieldConfiguration | string, callback?: never): Promise<T>;
    /**
