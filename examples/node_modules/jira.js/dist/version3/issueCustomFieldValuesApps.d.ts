...
export declare class IssueCustomFieldValuesApps {
     ...
     */
    updateMultipleCustomFieldValues<T = void>(parameters: Parameters.UpdateMultipleCustomFieldValues, callback: Callback<T>): Promise<void>;
    /**
     * Updates the value of one or more custom fields on one or more issues. Combinations of custom field and issue should
     * be unique within the request.
     *
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    updateMultipleCustomFieldValues<T = void>(parameters: Parameters.UpdateMultipleCustomFieldValues, callback?: never): Promise<T>;
    /**
