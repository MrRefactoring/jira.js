...
const instanceInformation_1 = require("../instanceInformation");
const issueAttachments_1 = require("../issueAttachments");
const issueBulkOperations_1 = require("../issueBulkOperations");
...
class Version3Client extends baseClient_1.BaseClient {
    constructor() {
        super(...arguments);
        ...
        this.issueBulkOperations = new issueBulkOperations_1.IssueBulkOperations(this);
...
//# sourceMappingURL=version3Client.js.map