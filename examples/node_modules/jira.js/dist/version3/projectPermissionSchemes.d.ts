...
export declare class ProjectPermissionSchemes {
     ...
     */
    getProjectIssueSecurityScheme<T = Models.SecurityScheme>(parameters: Parameters.GetProjectIssueSecurityScheme | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the [issue security scheme](https://confluence.atlassian.com/x/J4lKLg) associated with the project.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     * [project permission](https://confluence.atlassian.com/x/yodKLg).
     */
    getProjectIssueSecurityScheme<T = Models.SecurityScheme>(parameters: Parameters.GetProjectIssueSecurityScheme | string, callback?: never): Promise<T>;
    /**
     ...
     */
    getAssignedPermissionScheme<T = Models.PermissionScheme>(parameters: Parameters.GetAssignedPermissionScheme | string, callback: Callback<T>): Promise<void>;
    /**
     * Gets the [permission scheme](https://confluence.atlassian.com/x/yodKLg) associated with the project.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg).
     */
    getAssignedPermissionScheme<T = Models.PermissionScheme>(parameters: Parameters.GetAssignedPermissionScheme | string, callback?: never): Promise<T>;
    /**
     ...
     */
    getSecurityLevelsForProject<T = Models.ProjectIssueSecurityLevels>(parameters: Parameters.GetSecurityLevelsForProject | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns all [issue security](https://confluence.atlassian.com/x/J4lKLg) levels for the project that the user has
     * access to.
     *
     ...
     * permission](https://confluence.atlassian.com/x/x4dKLg) for the project.
     */
    getSecurityLevelsForProject<T = Models.ProjectIssueSecurityLevels>(parameters: Parameters.GetSecurityLevelsForProject | string, callback?: never): Promise<T>;
}
