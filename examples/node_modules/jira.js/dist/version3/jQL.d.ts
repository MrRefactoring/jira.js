...
export declare class JQL {
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    parseJqlQueries<T = Models.ParsedJqlQueries>(parameters: Parameters.ParseJqlQueries, callback: Callback<T>): Promise<void>;
    /**
     * Parses and validates JQL queries.
     *
     * Validation is performed in context of the current user.
     ...
     */
    sanitiseJqlQueries<T = Models.SanitizedJqlQueries>(parameters: Parameters.SanitiseJqlQueries | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Sanitizes one or more JQL queries by converting readable details into IDs where a user doesn't have permission to
     * view the entity.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    sanitiseJqlQueries<T = Models.SanitizedJqlQueries>(parameters?: Parameters.SanitiseJqlQueries, callback?: never): Promise<T>;
}
