...
export declare class Dashboards {
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    createDashboard<T = Models.Dashboard>(parameters: Parameters.CreateDashboard, callback: Callback<T>): Promise<void>;
    /**
     * Creates a dashboard.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     ...
     */
    bulkEditDashboards<T = Models.BulkEditShareableEntity>(parameters: Parameters.BulkEditDashboards, callback: Callback<T>): Promise<void>;
    /**
     * Bulk edit dashboards. Maximum number of dashboards to be edited at the same time is 100.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None
     ...
     * The dashboards to be updated must be owned by the user, or the user must be an administrator.
     */
    bulkEditDashboards<T = Models.BulkEditShareableEntity>(parameters: Parameters.BulkEditDashboards, callback?: never): Promise<T>;
    /**
     * Gets a list of all available gadgets that can be added to all dashboards.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    getAllAvailableDashboardGadgets<T = Models.AvailableDashboardGadgetsResponse>(callback: Callback<T>): Promise<void>;
    /**
     * Gets a list of all available gadgets that can be added to all dashboards.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    getAllAvailableDashboardGadgets<T = Models.AvailableDashboardGadgetsResponse>(callback?: never): Promise<T>;
    /**
     ...
     */
    getDashboardsPaginated<T = Models.PageDashboard>(parameters: Parameters.GetDashboardsPaginated | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     * dashboards. This operation is similar to [Get dashboards](#api-rest-api-3-dashboard-get) except that the results
     * can be refined to include dashboards that have specific attributes. For example, dashboards with a particular name.
     ...
     * - Dashboards shared with the public.
     */
    getDashboardsPaginated<T = Models.PageDashboard>(parameters?: Parameters.GetDashboardsPaginated, callback?: never): Promise<T>;
    /**
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    getAllGadgets<T = Models.DashboardGadgetResponse>(parameters: Parameters.GetAllGadgets | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of dashboard gadgets on a dashboard.
     *
     * This operation returns:
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    getAllGadgets<T = Models.DashboardGadgetResponse>(parameters: Parameters.GetAllGadgets | string, callback?: never): Promise<T>;
    /**
     * Adds a gadget to a dashboard.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    addGadget<T = Models.DashboardGadget>(parameters: Parameters.AddGadget, callback: Callback<T>): Promise<void>;
    /**
     * Adds a gadget to a dashboard.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    addGadget<T = Models.DashboardGadget>(parameters: Parameters.AddGadget, callback?: never): Promise<T>;
    /**
     * Changes the title, position, and color of the gadget on a dashboard.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    updateGadget<T = void>(parameters: Parameters.UpdateGadget, callback: Callback<T>): Promise<void>;
    /**
     * Changes the title, position, and color of the gadget on a dashboard.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    updateGadget<T = void>(parameters: Parameters.UpdateGadget, callback?: never): Promise<T>;
    /**
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    removeGadget<T = void>(parameters: Parameters.RemoveGadget, callback: Callback<T>): Promise<void>;
    /**
     * Removes a dashboard gadget from a dashboard.
     *
     * When a gadget is removed from a dashboard, other gadgets in the same column are moved up to fill the emptied
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    removeGadget<T = void>(parameters: Parameters.RemoveGadget, callback?: never): Promise<T>;
    /**
     ...
     */
    getDashboard<T = Models.Dashboard>(parameters: Parameters.GetDashboard | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a dashboard.
     *
     * This operation can be accessed anonymously.
     ...
     * System dashboard. The System dashboard is considered to be shared with all other users.
     */
    getDashboard<T = Models.Dashboard>(parameters: Parameters.GetDashboard | string, callback?: never): Promise<T>;
    /**
     ...
     */
    deleteDashboard<T = void>(parameters: Parameters.DeleteDashboard | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a dashboard.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None
     ...
     * The dashboard to be deleted must be owned by the user.
     */
    deleteDashboard<T = void>(parameters: Parameters.DeleteDashboard | string, callback?: never): Promise<T>;
    /**
