...
export declare class WorkflowStatusCategories {
     ...
     * Permission to access Jira.
     */
    getStatusCategory<T = Models.StatusCategory>(parameters: Parameters.GetStatusCategory | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a status category. Status categories provided a mechanism for categorizing
     * [statuses](#api-rest-api-3-status-idOrName-get).
     *
     ...
     * Permission to access Jira.
     */
    getStatusCategory<T = Models.StatusCategory>(parameters: Parameters.GetStatusCategory | string, callback?: never): Promise<T>;
}
