...
export declare class IssueCustomFieldContexts {
     ...
     */
    getContextsForField<T = Models.PageCustomFieldContext>(parameters: Parameters.GetContextsForField | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of [
     * contexts](https://confluence.atlassian.com/adminjiracloud/what-are-custom-field-contexts-991923859.html) for a
     * custom field. Contexts can be returned as follows:
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getContextsForField<T = Models.PageCustomFieldContext>(parameters: Parameters.GetContextsForField | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getDefaultValues<T = Models.PageCustomFieldContextDefaultValue>(parameters: Parameters.GetDefaultValues | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     * defaults for a custom field. The results can be filtered by `contextId`, otherwise all values are returned. If no
     * defaults are set for a context, nothing is returned.\
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getDefaultValues<T = Models.PageCustomFieldContextDefaultValue>(parameters: Parameters.GetDefaultValues | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getIssueTypeMappingsForContexts<T = Models.PageIssueTypeToContextMapping>(parameters: Parameters.GetIssueTypeMappingsForContexts | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     * context to issue type mappings for a custom field. Mappings are returned for all contexts or a list of contexts.
     * Mappings are ordered first by context ID and then by issue type ID.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getIssueTypeMappingsForContexts<T = Models.PageIssueTypeToContextMapping>(parameters: Parameters.GetIssueTypeMappingsForContexts | string, callback?: never): Promise<T>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getCustomFieldContextsForProjectsAndIssueTypes<T = Models.PageContextForProjectAndIssueType>(parameters: Parameters.GetCustomFieldContextsForProjectsAndIssueTypes, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     * project and issue type mappings and, for each mapping, the ID of a [custom field
     * context](https://confluence.atlassian.com/x/k44fOw) that applies to the project and issue type.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getCustomFieldContextsForProjectsAndIssueTypes<T = Models.PageContextForProjectAndIssueType>(parameters: Parameters.GetCustomFieldContextsForProjectsAndIssueTypes, callback?: never): Promise<T>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getProjectContextMapping<T = Models.PageCustomFieldContextProjectMapping>(parameters: Parameters.GetProjectContextMapping | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of
     * context to project mappings for a custom field. The result can be filtered by `contextId`. Otherwise, all mappings
     * are returned. Invalid IDs are ignored.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getProjectContextMapping<T = Models.PageCustomFieldContextProjectMapping>(parameters: Parameters.GetProjectContextMapping | string, callback?: never): Promise<T>;
    /**
