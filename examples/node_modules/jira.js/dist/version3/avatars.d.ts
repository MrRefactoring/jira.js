...
export declare class Avatars {
     ...
     */
    getAllSystemAvatars<T = Models.SystemAvatars>(parameters: Parameters.GetAllSystemAvatars | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of system avatar details by owner type, where the owner types are issue type, project, user or
     * priority.
     *
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    getAllSystemAvatars<T = Models.SystemAvatars>(parameters: Parameters.GetAllSystemAvatars | string, callback?: never): Promise<T>;
    /**
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    getAvatarImageByType<T = Models.AvatarWithDetails>(parameters: Parameters.GetAvatarImageByType | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the default project, issue type or priority avatar image.
     *
     * This operation can be accessed anonymously.
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** None.
     */
    getAvatarImageByType<T = Models.AvatarWithDetails>(parameters: Parameters.GetAvatarImageByType | string, callback?: never): Promise<T>;
    /**
     ...
     * - For priority avatars, none.
     */
    getAvatarImageByID<T = Models.AvatarWithDetails>(parameters: Parameters.GetAvatarImageByID, callback: Callback<T>): Promise<void>;
    /**
     * Returns a project, issue type or priority avatar image by ID.
     *
     * This operation can be accessed anonymously.
     ...
     * - For priority avatars, none.
     */
    getAvatarImageByID<T = Models.AvatarWithDetails>(parameters: Parameters.GetAvatarImageByID, callback?: never): Promise<T>;
    /**
     ...
     * - For priority avatars, none.
     */
    getAvatarImageByOwner<T = Models.AvatarWithDetails>(parameters: Parameters.GetAvatarImageByOwner, callback: Callback<T>): Promise<void>;
    /**
     * Returns the avatar image for a project, issue type or priority.
     *
     * This operation can be accessed anonymously.
     ...
     * - For priority avatars, none.
     */
    getAvatarImageByOwner<T = Models.AvatarWithDetails>(parameters: Parameters.GetAvatarImageByOwner, callback?: never): Promise<T>;
}
