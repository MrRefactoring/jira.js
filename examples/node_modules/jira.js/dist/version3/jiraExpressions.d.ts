...
export declare class JiraExpressions {
     ...
     */
    analyseExpression<T = Models.JiraExpressionsAnalysis>(parameters: Parameters.AnalyseExpression | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Analyses and validates Jira expressions.
     *
     * As an experimental feature, this operation can also attempt to type-check the expressions.
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required**: None.
     */
    analyseExpression<T = Models.JiraExpressionsAnalysis>(parameters?: Parameters.AnalyseExpression, callback?: never): Promise<T>;
    /**
     ...
     */
    evaluateJiraExpression<T = Models.JiraExpressionResult>(parameters: Parameters.EvaluateJiraExpression, callback: Callback<T>): Promise<void>;
    /**
     * Evaluates a Jira expression and returns its value.
     *
     * This resource can be used to test Jira expressions that you plan to use elsewhere, or to fetch data in a flexible
     ...
     * fields (for example, `issue.sprint`).
     */
    evaluateJiraExpression<T = Models.JiraExpressionResult>(parameters: Parameters.EvaluateJiraExpression, callback?: never): Promise<T>;
    /**
     ...
     */
    evaluateJiraExpressionUsingEnhancedSearch<T = Models.EvaluatedJiraExpression>(parameters: Parameters.EvaluateJiraExpressionUsingEnhancedSearch, callback: Callback<T>): Promise<void>;
    /**
     * Evaluates a Jira expression and returns its value. The difference between this and `eval` is that this endpoint
     * uses the enhanced search API when evaluating JQL queries. This API is eventually consistent, unlike the strongly
     * consistent `eval` API. This allows for better performance and scalability. In addition, this API's response for JQL
     ...
     * required to access Jira Software context variables (`board` and `sprint`) or fields (for example, `issue.sprint`).
     */
    evaluateJiraExpressionUsingEnhancedSearch<T = Models.EvaluatedJiraExpression>(parameters: Parameters.EvaluateJiraExpressionUsingEnhancedSearch, callback?: never): Promise<T>;
}
