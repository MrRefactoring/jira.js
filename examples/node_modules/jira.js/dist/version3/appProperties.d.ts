...
export declare class AppProperties {
     ...
     */
    getAddonProperties<T = Models.PropertyKeys>(parameters: Parameters.GetAddonProperties | string, callback: Callback<T>): Promise<void>;
    /**
     * Gets all the properties of an app.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** Only a
     ...
     * properties (stored against the same `app.connect.key`).
     */
    getAddonProperties<T = Models.PropertyKeys>(parameters: Parameters.GetAddonProperties | string, callback?: never): Promise<T>;
    /**
     ...
     */
    putAppProperty<T = Models.OperationMessage>(parameters: Parameters.PutAppProperty, callback: Callback<T>): Promise<void>;
    /**
     * Sets the value of a Forge app's property. These values can be retrieved in [Jira
     * expressions](https://developer.atlassian.com/cloud/jira/platform/jira-expressions/) through the `app` [context
     * variable](https://developer.atlassian.com/cloud/jira/platform/jira-expressions/#context-variables).
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    putAppProperty<T = Models.OperationMessage>(parameters: Parameters.PutAppProperty, callback?: never): Promise<T>;
    /**
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    deleteAppProperty<T = void>(parameters: Parameters.DeleteAppProperty, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a Forge app's property.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** Only
     ...
     * recommend adding it to your app's scope list because we will eventually make it mandatory.
     */
    deleteAppProperty<T = void>(parameters: Parameters.DeleteAppProperty, callback?: never): Promise<T>;
}
