...
export declare class IssueCustomFieldOptions {
     ...
     *   to view.
     */
    getCustomFieldOption<T = Models.CustomFieldOption>(parameters: Parameters.GetCustomFieldOption | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a custom field option. For example, an option in a select list.
     *
     * Note that this operation **only works for issue field select list options created in Jira or using operations from
     ...
     *   to view.
     */
    getCustomFieldOption<T = Models.CustomFieldOption>(parameters: Parameters.GetCustomFieldOption | string, callback?: never): Promise<T>;
    /**
     ...
     */
    getOptionsForContext<T = Models.PageCustomFieldContextOption>(parameters: Parameters.GetOptionsForContext, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of all
     * custom field option for a context. Options are returned first then cascading options, in the order they display in
     * Jira.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getOptionsForContext<T = Models.PageCustomFieldContextOption>(parameters: Parameters.GetOptionsForContext, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    replaceCustomFieldOption<T = unknown>(parameters: Parameters.ReplaceCustomFieldOption, callback: Callback<T>): Promise<void>;
    /**
     * Replaces the options of a custom field.
     *
     * Note that this operation **only works for issue field select list options created in Jira or using operations from
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    replaceCustomFieldOption<T = unknown>(parameters: Parameters.ReplaceCustomFieldOption, callback?: never): Promise<T>;
}
