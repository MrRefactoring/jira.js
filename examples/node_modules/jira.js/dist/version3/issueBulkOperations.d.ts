...
export declare class IssueBulkOperations {
    private client;
     ...
     *   to view the issue.
     */
    submitBulkDelete<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkDelete, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to submit a bulk delete request. You can delete up to 1,000 issues in a single operation.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     *   to view the issue.
     */
    submitBulkDelete<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkDelete, callback?: never): Promise<T>;
    /**
     ...
     */
    getBulkEditableFields<T = Models.BulkEditGetFields>(parameters: Parameters.GetBulkEditableFields, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to get a list of fields visible to the user to perform bulk edit operations. You can pass single or
     * multiple issues in the query to get eligible editable fields. This API uses pagination to return responses,
     * delivering 50 fields at a time.
     ...
     * - Depending on the field, any field-specific permissions required to edit it.
     */
    getBulkEditableFields<T = Models.BulkEditGetFields>(parameters: Parameters.GetBulkEditableFields, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    submitBulkEdit<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkEdit, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to submit a bulk edit request and simultaneously edit multiple issues. There are limits applied to the
     * number of issues and fields that can be edited. A single request can accommodate a maximum of 1000 issues
     * (including subtasks) and 200 fields.
     ...
     *   to view the issue.
     */
    submitBulkEdit<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkEdit, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    submitBulkMove<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkMove, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to submit a bulk issue move request. You can move multiple issues, but they must all be moved to and
     * from a single project, issue type, and parent. You can't move more than 1000 issues (including subtasks) at once.
     *
     ...
     *   to view the issue.
     */
    submitBulkMove<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkMove, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    getAvailableTransitions<T = Models.BulkTransitionGetAvailableTransitions>(parameters: Parameters.GetAvailableTransitions, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to retrieve a list of transitions available for the specified issues that can be used or bulk
     * transition operations. You can submit either single or multiple issues in the query to obtain the available
     * transitions.
     ...
     *   to view the issue.
     */
    getAvailableTransitions<T = Models.BulkTransitionGetAvailableTransitions>(parameters: Parameters.GetAvailableTransitions, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    submitBulkTransition<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkTransition, callback: Callback<T>): Promise<void>;
    /**
     * Use this API to submit a bulk issue status transition request. You can transition multiple issues, alongside with
     * their valid transition Ids. You can transition up to 1,000 issues in a single operation.
     *
     ...
     *   to view the issue.
     */
    submitBulkTransition<T = Models.SubmittedBulkOperation>(parameters: Parameters.SubmitBulkTransition, callback?: never): Promise<T>;
    /**
     ...
     */
    getBulkOperationProgress<T = Models.BulkOperationProgress>(parameters: Parameters.GetBulkOperationProgress, callback: Callback<T>): Promise<void>;
    /**
     * Use this to get the progress state for the specified bulk operation `taskId`.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
     ...
     * **Note:** You can view task progress for up to 14 days from creation.
     */
    getBulkOperationProgress<T = Models.BulkOperationProgress>(parameters: Parameters.GetBulkOperationProgress, callback?: never): Promise<T>;
}
