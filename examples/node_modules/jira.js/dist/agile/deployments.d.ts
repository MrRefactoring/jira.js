...
export declare class Deployments {
     ...
     */
    submitDeployments<T = Models.SubmitDeployments>(parameters: Parameters.SubmitDeployments, callback: Callback<T>): Promise<void>;
    /**
     * Update / insert deployment data.
     *
     * Deployments are identified by the combination of `pipelineId`, `environmentId` and `deploymentSequenceNumber`, and
     ...
     * resource. This resource requires the 'WRITE' scope for Connect apps.
     */
    submitDeployments<T = Models.SubmitDeployments>(parameters: Parameters.SubmitDeployments, callback?: never): Promise<T>;
    /**
     ...
     */
    deleteDeploymentsByProperty<T = unknown>(parameters: Parameters.DeleteDeploymentsByProperty, callback: Callback<T>): Promise<void>;
    /**
     * Bulk delete all deployments that match the given request.
     *
     * One or more query params must be supplied to specify the Properties to delete by. Optional param
     ...
     * resource. This resource requires the 'DELETE' scope for Connect apps.
     */
    deleteDeploymentsByProperty<T = unknown>(parameters: Parameters.DeleteDeploymentsByProperty, callback?: never): Promise<T>;
    /**
     ...
     */
    getDeploymentByKey<T = Models.GetDeploymentByKey>(parameters: Parameters.GetDeploymentByKey, callback: Callback<T>): Promise<void>;
    /**
     * Retrieve the currently stored deployment data for the given `pipelineId`, `environmentId` and
     * `deploymentSequenceNumber` combination.
     *
     ...
     * resource. This resource requires the 'READ' scope for Connect apps.
     */
    getDeploymentByKey<T = Models.GetDeploymentByKey>(parameters: Parameters.GetDeploymentByKey, callback?: never): Promise<T>;
    /**
     ...
     * resource. This resource requires the 'DELETE' scope for Connect apps.
     */
    deleteDeploymentByKey<T = unknown>(parameters: Parameters.DeleteDeploymentByKey, callback: Callback<T>): Promise<void>;
    /**
     * Delete the currently stored deployment data for the given `pipelineId`, `environmentId` and
     * `deploymentSequenceNumber` combination.
     *
     ...
     * resource. This resource requires the 'DELETE' scope for Connect apps.
     */
    deleteDeploymentByKey<T = unknown>(parameters: Parameters.DeleteDeploymentByKey, callback?: never): Promise<T>;
    /**
     ...
     */
    getDeploymentGatingStatusByKey<T = Models.GetDeploymentGatingStatusByKey>(parameters: Parameters.GetDeploymentGatingStatusByKey, callback: Callback<T>): Promise<void>;
    /**
     * Retrieve the Deployment gating status for the given `pipelineId + environmentId + deploymentSequenceNumber`
     * combination. Only apps that define the `jiraDeploymentInfoProvider` module can access this resource. This resource
     * requires the 'READ' scope.
     */
    getDeploymentGatingStatusByKey<T = Models.GetDeploymentGatingStatusByKey>(parameters: Parameters.GetDeploymentGatingStatusByKey, callback?: never): Promise<T>;
}
