...
export declare class SecurityInformation {
    private client;
     ...
     */
    submitWorkspaces<T = void>(parameters: Parameters.SubmitWorkspaces, callback: Callback<T>): Promise<void>;
    /**
     * Insert Security Workspace IDs to establish a relationship between them and the Jira site the app is installed on.
     * If a relationship between the workspace ID and Jira already exists then the workspace ID will be ignored and Jira
     * will process the rest of the entries.
     ...
     * requires the 'WRITE' scope for Connect apps.
     */
    submitWorkspaces<T = void>(parameters: Parameters.SubmitWorkspaces, callback?: never): Promise<T>;
    /**
     ...
     */
    deleteLinkedWorkspaces<T = void>(parameters: Parameters.DeleteLinkedWorkspaces, callback: Callback<T>): Promise<void>;
    /**
     * Bulk delete all linked Security Workspaces that match the given request.
     *
     * Only Connect apps that define the `jiraSecurityInfoProvider` module can access this resource. This resource
     ...
     * E.g. DELETE /bulk?workspaceIds=111-222-333,444-555-666
     */
    deleteLinkedWorkspaces<T = void>(parameters: Parameters.DeleteLinkedWorkspaces, callback?: never): Promise<T>;
    /**
     ...
     */
    getLinkedWorkspaces<T = Models.GetLinkedWorkspaces>(callback: Callback<T>): Promise<void>;
    /**
     * Retrieve all Security Workspaces linked with the Jira site.
     *
     * The result will be what is currently stored, ignoring any pending updates or deletes.
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getLinkedWorkspaces<T = Models.GetLinkedWorkspaces>(callback?: never): Promise<T>;
    /**
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getLinkedWorkspaceById<T = Models.GetLinkedWorkspaceById>(parameters: Parameters.GetLinkedWorkspaceById, callback: Callback<T>): Promise<void>;
    /**
     * Retrieve a specific Security Workspace linked to the Jira site for the given workspace ID.
     *
     * The result will be what is currently stored, ignoring any pending updates or deletes.
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getLinkedWorkspaceById<T = Models.GetLinkedWorkspaceById>(parameters: Parameters.GetLinkedWorkspaceById, callback?: never): Promise<T>;
    /**
     ...
     * requires the 'WRITE' scope for Connect apps.
     */
    submitVulnerabilities<T = Models.SubmitVulnerabilities>(parameters: Parameters.SubmitVulnerabilities, callback: Callback<T>): Promise<void>;
    /**
     * Update / Insert Vulnerability data.
     *
     * Vulnerabilities are identified by their ID, any existing Vulnerability data with the same ID will be replaced if it
     ...
     * requires the 'WRITE' scope for Connect apps.
     */
    submitVulnerabilities<T = Models.SubmitVulnerabilities>(parameters: Parameters.SubmitVulnerabilities, callback?: never): Promise<T>;
    /**
     ...
     * requires the 'DELETE' scope for Connect apps.
     */
    deleteVulnerabilitiesByProperty<T = void>(parameters: Parameters.DeleteVulnerabilitiesByProperty, callback: Callback<T>): Promise<void>;
    /**
     * Bulk delete all Vulnerabilities that match the given request.
     *
     * One or more query params must be supplied to specify Properties to delete by. If more than one Property is
     ...
     * requires the 'DELETE' scope for Connect apps.
     */
    deleteVulnerabilitiesByProperty<T = void>(parameters: Parameters.DeleteVulnerabilitiesByProperty, callback?: never): Promise<T>;
    /**
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getVulnerabilityById<T = Models.GetVulnerabilityById>(parameters: Parameters.GetVulnerabilityById, callback: Callback<T>): Promise<void>;
    /**
     * Retrieve the currently stored Vulnerability data for the given ID.
     *
     * The result will be what is currently stored, ignoring any pending updates or deletes.
     ...
     * requires the 'READ' scope for Connect apps.
     */
    getVulnerabilityById<T = Models.GetVulnerabilityById>(parameters: Parameters.GetVulnerabilityById, callback?: never): Promise<T>;
    /**
     ...
     * requires the 'DELETE' scope for Connect apps.
     */
    deleteVulnerabilityById<T = void>(parameters: Parameters.DeleteVulnerabilityById, callback: Callback<T>): Promise<void>;
    /**
     * Delete the Vulnerability data currently stored for the given ID.
     *
     * Deletion is performed asynchronously. The GET vulnerability endpoint can be used to confirm that data has been
     ...
     * requires the 'DELETE' scope for Connect apps.
     */
    deleteVulnerabilityById<T = void>(parameters: Parameters.DeleteVulnerabilityById, callback?: never): Promise<T>;
}
