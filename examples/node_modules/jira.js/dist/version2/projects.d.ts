...
export declare class Projects {
     ...
     */
    createProject<T = Models.ProjectIdentifiers>(parameters: Parameters.CreateProject, callback: Callback<T>): Promise<void>;
    /**
     * Creates a project based on a project type template, as shown in the following table:
     *
     * | Project Type Key | Project Template Key                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    createProject<T = Models.ProjectIdentifiers>(parameters: Parameters.CreateProject, callback?: never): Promise<T>;
    /**
     ...
     * - _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getRecent<T = Models.Project[]>(parameters: Parameters.GetRecent | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of up to 20 projects recently viewed by the user that are still visible to the user.
     *
     * This operation can be accessed anonymously.
     ...
     * - _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getRecent<T = Models.Project[]>(parameters?: Parameters.GetRecent, callback?: never): Promise<T>;
    /**
     ...
     * - _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    searchProjects<T = Models.PageProject>(parameters: Parameters.SearchProjects | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of
     * projects visible to the user.
     *
     ...
     * - _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    searchProjects<T = Models.PageProject>(parameters?: Parameters.SearchProjects, callback?: never): Promise<T>;
    /**
     ...
     */
    getProject<T = Models.Project>(parameters: Parameters.GetProject | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the [project details](https://confluence.atlassian.com/x/ahLpNw) for a project.
     *
     * This operation can be accessed anonymously.
     ...
     * projects_ [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
     */
    getProject<T = Models.Project>(parameters: Parameters.GetProject | string, callback?: never): Promise<T>;
    /**
     ...
     */
    updateProject<T = Models.Project>(parameters: Parameters.UpdateProject, callback: Callback<T>): Promise<void>;
    /**
     * Updates the [project details](https://confluence.atlassian.com/x/ahLpNw) of a project.
     *
     * All parameters are optional in the body of the request. Schemes will only be updated if they are included in the
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg)
     */
    updateProject<T = Models.Project>(parameters: Parameters.UpdateProject, callback?: never): Promise<T>;
    /**
     * Deletes a project.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteProject<T = void>(parameters: Parameters.DeleteProject | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a project.
     *
     * You can't delete a project if it's archived. To delete an archived project, restore the project and then delete it.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteProject<T = void>(parameters: Parameters.DeleteProject | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    archiveProject<T = void>(parameters: Parameters.ArchiveProject | string, callback: Callback<T>): Promise<void>;
    /**
     * Archives a project. You can't delete a project if it's archived. To delete an archived project, restore the project
     * and then delete it. To restore a project, use the Jira UI.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    archiveProject<T = void>(parameters: Parameters.ArchiveProject | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteProjectAsynchronously<T = unknown>(parameters: Parameters.DeleteProjectAsynchronously | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a project asynchronously.
     *
     * This operation is:
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteProjectAsynchronously<T = unknown>(parameters: Parameters.DeleteProjectAsynchronously | string, callback?: never): Promise<T>;
    /**
     ...
     */
    restore<T = Models.Project>(parameters: Parameters.Restore | string, callback: Callback<T>): Promise<void>;
    /**
     * Restores a project that has been archived or placed in the Jira recycle bin.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     ...
     *   permission](https://confluence.atlassian.com/x/yodKLg) for the project for Team managed projects.
     */
    restore<T = Models.Project>(parameters: Parameters.Restore | string, callback?: never): Promise<T>;
    /**
     ...
     * Projects_ [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
     */
    getAllStatuses<T = Models.IssueTypeWithStatus[]>(parameters: Parameters.GetAllStatuses | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the valid statuses for a project. The statuses are grouped by issue type, as each project has a set of
     * valid issue types and each issue type has a set of valid statuses.
     *
     ...
     * Projects_ [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
     */
    getAllStatuses<T = Models.IssueTypeWithStatus[]>(parameters: Parameters.GetAllStatuses | string, callback?: never): Promise<T>;
    /**
     ...
     * projects_ [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
     */
    getHierarchy<T = Models.ProjectIssueTypeHierarchy>(parameters: Parameters.GetHierarchy | string, callback: Callback<T>): Promise<void>;
    /**
     * Get the issue type hierarchy for a next-gen project.
     *
     * The issue type hierarchy for a project consists of:
     ...
     * projects_ [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
     */
    getHierarchy<T = Models.ProjectIssueTypeHierarchy>(parameters: Parameters.GetHierarchy | string, callback?: never): Promise<T>;
    /**
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg).
     */
    getNotificationSchemeForProject<T = Models.NotificationScheme>(parameters: Parameters.GetNotificationSchemeForProject | string, callback: Callback<T>): Promise<void>;
    /**
     * Gets a [notification scheme](https://confluence.atlassian.com/x/8YdKLg) associated with the project.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg).
     */
    getNotificationSchemeForProject<T = Models.NotificationScheme>(parameters: Parameters.GetNotificationSchemeForProject | string, callback?: never): Promise<T>;
}
