...
export declare class UserSearch {
     ...
     */
    findBulkAssignableUsers<T = Models.User[]>(parameters: Parameters.FindBulkAssignableUsers, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of users who can be assigned issues in one or more projects. The list may be restricted to users
     * whose attributes match a string.
     *
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** None.
     */
    findBulkAssignableUsers<T = Models.User[]>(parameters: Parameters.FindBulkAssignableUsers, callback?: never): Promise<T>;
    /**
     ...
     */
    findAssignableUsers<T = Models.User[]>(parameters: Parameters.FindAssignableUsers | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of users that can be assigned to an issue. Use this operation to find the list of users who can be
     * assigned to:
     *
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg)
     */
    findAssignableUsers<T = Models.User[]>(parameters?: Parameters.FindAssignableUsers, callback?: never): Promise<T>;
    /**
     ...
     *   for that project.
     */
    findUsersWithAllPermissions<T = Models.User[]>(parameters: Parameters.FindUsersWithAllPermissions, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of users who fulfill these criteria:
     *
     * - Their user attributes match a search string.
     ...
     *   for that project.
     */
    findUsersWithAllPermissions<T = Models.User[]>(parameters: Parameters.FindUsersWithAllPermissions, callback?: never): Promise<T>;
    /**
     ...
     */
    findUsersForPicker<T = Models.FoundUsers>(parameters: Parameters.FindUsersForPicker, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of users whose attributes match the query term. The returned object includes the `html` field where
     * the matched query term is highlighted with the HTML strong tag. A list of account IDs can be provided to exclude
     * users from the results.
     ...
     * users without the required permission return search results for an exact name match only.
     */
    findUsersForPicker<T = Models.FoundUsers>(parameters: Parameters.FindUsersForPicker, callback?: never): Promise<T>;
    /**
     ...
     */
    findUsers<T = Models.User[]>(parameters: Parameters.FindUsers | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of active users that match the search string and property.
     *
     * This operation first applies a filter to match the search string and property, and then takes the filtered users in
     ...
     * without the required permission return empty search results.
     */
    findUsers<T = Models.User[]>(parameters?: Parameters.FindUsers, callback?: never): Promise<T>;
    /**
     ...
     */
    findUsersByQuery<T = Models.PageUser>(parameters: Parameters.FindUsersByQuery, callback: Callback<T>): Promise<void>;
    /**
     * Finds users with a structured query and returns a
     * [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of user details.
     *
     ...
     * `is assignee of PROJ AND [propertyKey].entity.property.path is "property value"`
     */
    findUsersByQuery<T = Models.PageUser>(parameters: Parameters.FindUsersByQuery, callback?: never): Promise<T>;
    /**
     * Finds users with a structured query and returns a
     ...
     * `is assignee of PROJ AND [propertyKey].entity.property.path is "property value"`
     */
    findUserKeysByQuery<T = Models.PageUserKey>(parameters: Parameters.FindUserKeysByQuery, callback: Callback<T>): Promise<void>;
    /**
     * Finds users with a structured query and returns a
     * [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of user keys.
     *
     ...
     * `is assignee of PROJ AND [propertyKey].entity.property.path is "property value"`
     */
    findUserKeysByQuery<T = Models.PageUserKey>(parameters: Parameters.FindUserKeysByQuery, callback?: never): Promise<T>;
    /**
     * Returns a list of users who fulfill these criteria:
     *
     * - Their user attributes match a search string.
     ...
     */
    findUsersWithBrowsePermission<T = Models.User[]>(parameters: Parameters.FindUsersWithBrowsePermission | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of users who fulfill these criteria:
     *
     * - Their user attributes match a search string.
     ...
     * users without the required permission return empty search results.
     */
    findUsersWithBrowsePermission<T = Models.User[]>(parameters?: Parameters.FindUsersWithBrowsePermission, callback?: never): Promise<T>;
}
