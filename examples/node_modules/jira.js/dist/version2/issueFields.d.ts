...
export declare class IssueFields {
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getFieldsPaginated<T = Models.PageField>(parameters: Parameters.GetFieldsPaginated | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of fields
     * for Classic Jira projects. The list can include:
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getFieldsPaginated<T = Models.PageField>(parameters?: Parameters.GetFieldsPaginated, callback?: never): Promise<T>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of fields
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getTrashedFieldsPaginated<T = Models.PageField>(parameters: Parameters.GetTrashedFieldsPaginated | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of fields
     * in the trash. The list may be restricted to fields whose field name or description partially match a string.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getTrashedFieldsPaginated<T = Models.PageField>(parameters?: Parameters.GetTrashedFieldsPaginated, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    restoreCustomField<T = unknown>(parameters: Parameters.RestoreCustomField, callback: Callback<T>): Promise<void>;
    /**
     * Restores a custom field from trash. See [Edit or delete a custom field](https://confluence.atlassian.com/x/Z44fOw)
     * for more information on trashing and deleting custom fields.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    restoreCustomField<T = unknown>(parameters: Parameters.RestoreCustomField, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    trashCustomField<T = unknown>(parameters: Parameters.TrashCustomField, callback: Callback<T>): Promise<void>;
    /**
     * Moves a custom field to trash. See [Edit or delete a custom field](https://confluence.atlassian.com/x/Z44fOw) for
     * more information on trashing and deleting custom fields.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    trashCustomField<T = unknown>(parameters: Parameters.TrashCustomField, callback?: never): Promise<T>;
}
