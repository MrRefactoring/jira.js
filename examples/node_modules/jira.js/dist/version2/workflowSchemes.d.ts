...
export declare class WorkflowSchemes {
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    createWorkflowScheme<T = Models.WorkflowScheme>(parameters: Parameters.CreateWorkflowScheme, callback: Callback<T>): Promise<void>;
    /**
     * Creates a workflow scheme.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     ...
     */
    readWorkflowSchemes<T = Models.WorkflowSchemeReadResponse[]>(parameters: Parameters.ReadWorkflowSchemes, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of workflow schemes by providing workflow scheme IDs or project IDs.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     ...
     * - _Administer projects_ project permissions to access project-scoped workflow schemes
     */
    readWorkflowSchemes<T = Models.WorkflowSchemeReadResponse[]>(parameters: Parameters.ReadWorkflowSchemes, callback?: never): Promise<T>;
    /**
     ...
     */
    updateSchemes<T = unknown>(parameters: Parameters.UpdateSchemes, callback: Callback<T>): Promise<void>;
    /**
     * Updates company-managed and team-managed project workflow schemes. This API doesn't have a concept of draft, so any
     * changes made to a workflow scheme are immediately available. When changing the available statuses for issue types,
     * an [asynchronous task](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#async-operations)
     ...
     * - _Administer projects_ project permission to update project-scoped workflow schemes.
     */
    updateSchemes<T = unknown>(parameters: Parameters.UpdateSchemes, callback?: never): Promise<T>;
    /**
     ...
     * - _Administer projects_ project permission to update project-scoped workflow schemes.
     */
    updateWorkflowSchemeMappings<T = Models.WorkflowSchemeUpdateRequiredMappingsResponse>(parameters: Parameters.UpdateWorkflowSchemeMappings, callback: Callback<T>): Promise<void>;
    /**
     * Gets the required status mappings for the desired changes to a workflow scheme. The results are provided per issue
     * type and workflow. When updating a workflow scheme, status mappings can be provided per issue type, per workflow,
     * or both.
     ...
     * - _Administer projects_ project permission to update project-scoped workflow schemes.
     */
    updateWorkflowSchemeMappings<T = Models.WorkflowSchemeUpdateRequiredMappingsResponse>(parameters: Parameters.UpdateWorkflowSchemeMappings, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getWorkflowScheme<T = Models.WorkflowScheme>(parameters: Parameters.GetWorkflowScheme | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a workflow scheme.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getWorkflowScheme<T = Models.WorkflowScheme>(parameters: Parameters.GetWorkflowScheme | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteWorkflowScheme<T = void>(parameters: Parameters.DeleteWorkflowScheme | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a workflow scheme. Note that a workflow scheme cannot be deleted if it is active (that is, being used by at
     * least one project).
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteWorkflowScheme<T = void>(parameters: Parameters.DeleteWorkflowScheme | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getDefaultWorkflow<T = Models.DefaultWorkflow>(parameters: Parameters.GetDefaultWorkflow | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the default workflow for a workflow scheme. The default workflow is the workflow that is assigned any issue
     * types that have not been mapped to any other workflow. The default workflow has _All Unassigned Issue Types_ listed
     * in its issue types for the workflow scheme in Jira.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getDefaultWorkflow<T = Models.DefaultWorkflow>(parameters: Parameters.GetDefaultWorkflow | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteDefaultWorkflow<T = Models.WorkflowScheme>(parameters: Parameters.DeleteDefaultWorkflow | string, callback: Callback<T>): Promise<void>;
    /**
     * Resets the default workflow for a workflow scheme. That is, the default workflow is set to Jira's system workflow
     * (the _jira_ workflow).
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteDefaultWorkflow<T = Models.WorkflowScheme>(parameters: Parameters.DeleteDefaultWorkflow | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getWorkflow<T = Models.IssueTypesWorkflowMapping>(parameters: Parameters.GetWorkflow | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the workflow-issue type mappings for a workflow scheme.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getWorkflow<T = Models.IssueTypesWorkflowMapping>(parameters: Parameters.GetWorkflow | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteWorkflowMapping<T = unknown>(parameters: Parameters.DeleteWorkflowMapping | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes the workflow-issue type mapping for a workflow in a workflow scheme.
     *
     * Note that active workflow schemes cannot be edited. If the workflow scheme is active, set `updateDraftIfNeeded` to
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteWorkflowMapping<T = unknown>(parameters: Parameters.DeleteWorkflowMapping | string, callback?: never): Promise<T>;
    /** Returns a page of projects using a given workflow scheme. */
    getProjectUsagesForWorkflowScheme<T = Models.WorkflowSchemeProjectUsage>(parameters: Parameters.GetProjectUsagesForWorkflowScheme, callback: Callback<T>): Promise<void>;
    /** Returns a page of projects using a given workflow scheme. */
    getProjectUsagesForWorkflowScheme<T = Models.WorkflowSchemeProjectUsage>(parameters: Parameters.GetProjectUsagesForWorkflowScheme, callback?: never): Promise<T>;
}
