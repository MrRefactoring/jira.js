...
export declare class Issues {
     ...
     *   to view the issues.
     */
    getBulkChangelogs<T = Models.BulkChangelog>(parameters: Parameters.GetBulkChangelogs, callback: Callback<T>): Promise<void>;
    /**
     * Bulk fetch changelogs for multiple issues and filter by fields
     *
     * Returns a paginated list of all changelogs for given issues sorted by changelog date and issue IDs, starting from
     ...
     *   to view the issues.
     */
    getBulkChangelogs<T = Models.BulkChangelog>(parameters: Parameters.GetBulkChangelogs, callback?: never): Promise<T>;
    /**
     ...
     */
    archiveIssuesAsync<T = string>(parameters: Parameters.ArchiveIssuesAsync, callback: Callback<T>): Promise<void>;
    /**
     * Enables admins to archive up to 100,000 issues in a single request using JQL, returning the URL to check the status
     * of the submitted request.
     *
     ...
     * **Rate limiting:** Only a single request per jira instance can be active at any given time.
     */
    archiveIssuesAsync<T = string>(parameters: Parameters.ArchiveIssuesAsync, callback?: never): Promise<T>;
    /**
     ...
     * **Signed-in users only:** This API can't be accessed anonymously.
     */
    archiveIssues<T = Models.IssueArchivalSync>(parameters: Parameters.ArchiveIssues, callback: Callback<T>): Promise<void>;
    /**
     * Enables admins to archive up to 1000 issues in a single request using issue ID/key, returning details of the
     * issue(s) archived in the process and the errors encountered, if any.
     *
     ...
     * **Signed-in users only:** This API can't be accessed anonymously.
     */
    archiveIssues<T = Models.IssueArchivalSync>(parameters: Parameters.ArchiveIssues, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    bulkFetchIssues<T = Models.BulkIssue>(parameters: Parameters.BulkFetchIssues, callback: Callback<T>): Promise<void>;
    /**
     * Returns the details for a set of requested issues. You can request up to 100 issues.
     *
     * Each issue is identified by its ID or key, however, if the identifier doesn't match an issue, a case-insensitive
     ...
     *   to view the issue.
     */
    bulkFetchIssues<T = Models.BulkIssue>(parameters: Parameters.BulkFetchIssues, callback?: never): Promise<T>;
    /**
     ...
     * issues_ [project permission](https://confluence.atlassian.com/x/yodKLg) in the requested projects.
     */
    getCreateIssueMetaIssueTypes<T = Models.PageOfCreateMetaIssueTypes>(parameters: Parameters.GetCreateIssueMetaIssueTypes, callback: Callback<T>): Promise<void>;
    /**
     * Returns a page of issue type metadata for a specified project. Use the information to populate the requests in [
     * Create issue](#api-rest-api-2-issue-post) and [Create issues](#api-rest-api-2-issue-bulk-post).
     *
     ...
     * issues_ [project permission](https://confluence.atlassian.com/x/yodKLg) in the requested projects.
     */
    getCreateIssueMetaIssueTypes<T = Models.PageOfCreateMetaIssueTypes>(parameters: Parameters.GetCreateIssueMetaIssueTypes, callback?: never): Promise<T>;
    /**
     ...
     * issues_ [project permission](https://confluence.atlassian.com/x/yodKLg) in the requested projects.
     */
    getCreateIssueMetaIssueTypeId<T = Models.PageOfCreateMetaIssueTypeWithField>(parameters: Parameters.GetCreateIssueMetaIssueTypeId, callback: Callback<T>): Promise<void>;
    /**
     * Returns a page of field metadata for a specified project and issuetype id. Use the information to populate the
     * requests in [ Create issue](#api-rest-api-2-issue-post) and [Create issues](#api-rest-api-2-issue-bulk-post).
     *
     ...
     * issues_ [project permission](https://confluence.atlassian.com/x/yodKLg) in the requested projects.
     */
    getCreateIssueMetaIssueTypeId<T = Models.PageOfCreateMetaIssueTypeWithField>(parameters: Parameters.GetCreateIssueMetaIssueTypeId, callback?: never): Promise<T>;
    /**
     ...
     * - _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getIssueLimitReport<T = Models.IssueLimitReport>(parameters: Parameters.GetIssueLimitReport | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns all issues breaching and approaching per-issue limits.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
     ...
     * - _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getIssueLimitReport<T = Models.IssueLimitReport>(parameters?: Parameters.GetIssueLimitReport, callback?: never): Promise<T>;
    /**
     ...
     * **Signed-in users only:** This API can't be accessed anonymously.
     */
    unarchiveIssues<T = Models.IssueArchivalSync>(parameters: Parameters.UnarchiveIssues, callback: Callback<T>): Promise<void>;
    /**
     * Enables admins to unarchive up to 1000 issues in a single request using issue ID/key, returning details of the
     * issue(s) unarchived in the process and the errors encountered, if any.
     *
     ...
     * **Signed-in users only:** This API can't be accessed anonymously.
     */
    unarchiveIssues<T = Models.IssueArchivalSync>(parameters: Parameters.UnarchiveIssues, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    getIssue<T = Models.Issue>(parameters: Parameters.GetIssue | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the details for an issue.
     *
     * The issue is identified by its ID or key, however, if the identifier doesn't match an issue, a case-insensitive
     ...
     *   to view the issue.
     */
    getIssue<T = Models.Issue>(parameters: Parameters.GetIssue | string, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    deleteIssue<T = void>(parameters: Parameters.DeleteIssue | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes an issue.
     *
     * An issue cannot be deleted if it has one or more subtasks. To delete an issue with subtasks, set `deleteSubtasks`.
     ...
     *   to view the issue.
     */
    deleteIssue<T = void>(parameters: Parameters.DeleteIssue | string, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    getChangeLogs<T = Models.PageChangelog>(parameters: Parameters.GetChangeLogs | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of all
     * changelogs for an issue sorted by date, starting from the oldest.
     *
     ...
     *   to view the issue.
     */
    getChangeLogs<T = Models.PageChangelog>(parameters: Parameters.GetChangeLogs | string, callback?: never): Promise<T>;
    /**
     ...
     */
    getEditIssueMeta<T = Models.IssueUpdateMetadata>(parameters: Parameters.GetEditIssueMeta | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the edit screen fields for an issue that are visible to and editable by the user. Use the information to
     * populate the requests in [Edit issue](#api-rest-api-2-issue-issueIdOrKey-put).
     *
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg) for the issue.
     */
    getEditIssueMeta<T = Models.IssueUpdateMetadata>(parameters: Parameters.GetEditIssueMeta | string, callback?: never): Promise<T>;
    /**
     ...
     */
    getTransitions<T = Models.Transitions>(parameters: Parameters.GetTransitions | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns either all transitions or a transition that can be performed by the user on an issue, based on the issue's
     * status.
     *
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg) the response will not list any transitions.
     */
    getTransitions<T = Models.Transitions>(parameters: Parameters.GetTransitions | string, callback?: never): Promise<T>;
    /**
     ...
     */
    exportArchivedIssues<T = Models.ExportArchivedIssuesTaskProgress>(parameters: Parameters.ExportArchivedIssues, callback: Callback<T>): Promise<void>;
    /**
     * Enables admins to retrieve details of all archived issues. Upon a successful request, the admin who submitted it
     * will receive an email with a link to download a CSV file with the issue details.
     *
     ...
     * **Rate limiting:** Only a single request can be active at any given time.
     */
    exportArchivedIssues<T = Models.ExportArchivedIssuesTaskProgress>(parameters: Parameters.ExportArchivedIssues, callback?: never): Promise<T>;
}
