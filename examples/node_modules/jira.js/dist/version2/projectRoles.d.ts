...
export declare class ProjectRoles {
     ...
     */
    getProjectRoles<T = Record<string, string>>(parameters: Parameters.GetProjectRoles | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of [project
     * roles](https://support.atlassian.com/jira-cloud-administration/docs/manage-project-roles/) for the project
     * returning the name and self URL for each role.
     ...
     * or _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getProjectRoles<T = Record<string, string>>(parameters: Parameters.GetProjectRoles | string, callback?: never): Promise<T>;
    /**
     ...
     */
    getProjectRoleDetails<T = Models.ProjectRoleDetails[]>(parameters: Parameters.GetProjectRoleDetails | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns all [project roles](https://support.atlassian.com/jira-cloud-administration/docs/manage-project-roles/) and
     * the details for each role. Note that the list of project roles is common to all projects.
     *
     ...
     * permission](https://confluence.atlassian.com/x/yodKLg) for the project.
     */
    getProjectRoleDetails<T = Models.ProjectRoleDetails[]>(parameters: Parameters.GetProjectRoleDetails | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    createProjectRole<T = Models.ProjectRole>(parameters: Parameters.CreateProjectRole, callback: Callback<T>): Promise<void>;
    /**
     * Creates a new project role with no [default actors](#api-rest-api-2-resolution-get). You can use the [Add default
     * actors to project role](#api-rest-api-2-role-id-actors-post) operation to add default actors to the project role
     * after creating it.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getProjectRoleById<T = Models.ProjectRole>(parameters: Parameters.GetProjectRoleById | string, callback: Callback<T>): Promise<void>;
    /**
     * Gets the project role details and the default actors associated with the role. The list of default actors is sorted
     * by display name.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getProjectRoleById<T = Models.ProjectRole>(parameters: Parameters.GetProjectRoleById | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteProjectRole<T = void>(parameters: Parameters.DeleteProjectRole | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a project role. You must specify a replacement project role if you wish to delete a project role that is in
     * use.
     *
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteProjectRole<T = void>(parameters: Parameters.DeleteProjectRole | string, callback?: never): Promise<T>;
}
