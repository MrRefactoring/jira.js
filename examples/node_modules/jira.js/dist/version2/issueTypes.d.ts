...
export declare class IssueTypes {
     ...
     */
    getIssueType<T = Models.IssueTypeDetails>(parameters: Parameters.GetIssueType | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns an issue type.
     *
     * This operation can be accessed anonymously.
     ...
     * with or _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    getIssueType<T = Models.IssueTypeDetails>(parameters: Parameters.GetIssueType | string, callback?: never): Promise<T>;
    /**
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteIssueType<T = void>(parameters: Parameters.DeleteIssueType | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes the issue type. If the issue type is in use, all uses are updated with the alternative issue type
     * (`alternativeIssueTypeId`). A list of alternative issue types are obtained from the [Get alternative issue
     * types](#api-rest-api-2-issuetype-id-alternatives-get) resource.
     ...
     * _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
     */
    deleteIssueType<T = void>(parameters: Parameters.DeleteIssueType | string, callback?: never): Promise<T>;
    /**
     ...
     */
    getAlternativeIssueTypes<T = Models.IssueTypeDetails[]>(parameters: Parameters.GetAlternativeIssueTypes | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of issue types that can be used to replace the issue type. The alternative issue types are those
     * assigned to the same workflow scheme, field configuration scheme, and screen scheme.
     *
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** None.
     */
    getAlternativeIssueTypes<T = Models.IssueTypeDetails[]>(parameters: Parameters.GetAlternativeIssueTypes | string, callback?: never): Promise<T>;
    /**
