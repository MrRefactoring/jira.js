...
export declare class IssueWatchers {
     ...
     *   to view the issue.
     */
    getIsWatchingIssueBulk<T = Models.BulkIssueIsWatching>(parameters: Parameters.GetIsWatchingIssueBulk | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Returns, for the user, details of the watched status of issues from a list. If an issue ID is invalid, the returned
     * watched status is `false`.
     *
     ...
     *   to view the issue.
     */
    getIsWatchingIssueBulk<T = Models.BulkIssueIsWatching>(parameters?: Parameters.GetIsWatchingIssueBulk, callback?: never): Promise<T>;
    /**
     ...
     */
    getIssueWatchers<T = Models.Watchers>(parameters: Parameters.GetIssueWatchers | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the watchers for an issue.
     *
     * This operation requires the **Allow users to watch issues** option to be _ON_. This option is set in General
     ...
     *   permission](https://confluence.atlassian.com/x/yodKLg) for the project that the issue is in.
     */
    getIssueWatchers<T = Models.Watchers>(parameters: Parameters.GetIssueWatchers | string, callback?: never): Promise<T>;
    /**
