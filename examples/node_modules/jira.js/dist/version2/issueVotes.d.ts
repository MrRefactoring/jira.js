...
export declare class IssueVotes {
     ...
     */
    getVotes<T = Models.Votes>(parameters: Parameters.GetVotes | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns details about the votes on an issue.
     *
     * This operation requires the **Allow users to vote on issues** option to be _ON_. This option is set in General
     ...
     * project permissions are not returned details in the `voters` field.
     */
    getVotes<T = Models.Votes>(parameters: Parameters.GetVotes | string, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    addVote<T = void>(parameters: Parameters.AddVote | string, callback: Callback<T>): Promise<void>;
    /**
     * Adds the user's vote to an issue. This is the equivalent of the user clicking _Vote_ on an issue in Jira.
     *
     * This operation requires the **Allow users to vote on issues** option to be _ON_. This option is set in General
     ...
     *   to view the issue.
     */
    addVote<T = void>(parameters: Parameters.AddVote | string, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    removeVote<T = void>(parameters: Parameters.RemoveVote | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a user's vote from an issue. This is the equivalent of the user clicking _Unvote_ on an issue in Jira.
     *
     * This operation requires the **Allow users to vote on issues** option to be _ON_. This option is set in General
     ...
     *   to view the issue.
     */
    removeVote<T = void>(parameters: Parameters.RemoveVote | string, callback?: never): Promise<T>;
}
