...
export declare class WorkflowTransitionRules {
     ...
     */
    getWorkflowTransitionRuleConfigurations<T = Models.PageWorkflowTransitionRules>(parameters: Parameters.GetWorkflowTransitionRuleConfigurations, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of
     * workflows with transition rules. The workflows can be filtered to return only those containing workflow transition
     * rules:
     ...
     * [Forge](https://developer.atlassian.com/cloud/jira/platform/index/#forge-apps) apps can use this operation.
     */
    getWorkflowTransitionRuleConfigurations<T = Models.PageWorkflowTransitionRules>(parameters: Parameters.GetWorkflowTransitionRuleConfigurations, callback?: never): Promise<T>;
    /**
     ...
     * [Forge](https://developer.atlassian.com/cloud/jira/platform/index/#forge-apps) apps can use this operation.
     */
    updateWorkflowTransitionRuleConfigurations<T = Models.WorkflowTransitionRulesUpdateErrors>(parameters: Parameters.UpdateWorkflowTransitionRuleConfigurations, callback: Callback<T>): Promise<void>;
    /**
     * Updates configuration of workflow transition rules. The following rule types are supported:
     *
     * - [post functions](https://developer.atlassian.com/cloud/jira/platform/modules/workflow-post-function/)
