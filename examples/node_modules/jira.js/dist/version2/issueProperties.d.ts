...
export declare class IssueProperties {
     ...
     *   to view the issue.
     */
    bulkSetIssuePropertiesByIssue<T = unknown>(parameters: Parameters.BulkSetIssuePropertiesByIssue | undefined, callback: Callback<T>): Promise<void>;
    /**
     * Sets or updates entity property values on issues. Up to 10 entity properties can be specified for each issue and up
     * to 100 issues included in the request.
     *
     ...
     *   to view the issue.
     */
    bulkSetIssuePropertiesByIssue<T = unknown>(parameters?: Parameters.BulkSetIssuePropertiesByIssue, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    getIssuePropertyKeys<T = Models.PropertyKeys>(parameters: Parameters.GetIssuePropertyKeys | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the URLs and keys of an issue's properties.
     *
     * This operation can be accessed anonymously.
     ...
     *   to view the issue.
     */
    getIssuePropertyKeys<T = Models.PropertyKeys>(parameters: Parameters.GetIssuePropertyKeys | string, callback?: never): Promise<T>;
    /**
