...
export declare class AppMigration {
     ...
     * app.
     */
    workflowRuleSearch<T = Models.WorkflowRulesSearchDetails>(parameters: Parameters.WorkflowRuleSearch, callback: Callback<T>): Promise<void>;
    /**
     * Returns configurations for workflow transition rules migrated from server to cloud and owned by the calling Connect
     * app.
     */
    workflowRuleSearch<T = Models.WorkflowRulesSearchDetails>(parameters: Parameters.WorkflowRuleSearch, callback?: never): Promise<T>;
}
