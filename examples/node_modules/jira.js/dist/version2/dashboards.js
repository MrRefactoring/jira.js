    ...
    getAllGadgets(parameters, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const config = {
                ...
                method: 'GET',
                params: {
                    moduleKey: typeof parameters !== 'string' && (0, paramSerializer_1.paramSerializer)('moduleKey', parameters.moduleKey),
                    uri: typeof parameters !== 'string' && parameters.uri,
                    gadgetId: typeof parameters !== 'string' && (0, paramSerializer_1.paramSerializer)('gadgetId', parameters.gadgetId),
                },
            };
            return this.client.sendRequest(config, callback);
        });
