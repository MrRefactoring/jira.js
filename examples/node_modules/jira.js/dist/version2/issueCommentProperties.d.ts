...
export declare class IssueCommentProperties {
     ...
     */
    getCommentPropertyKeys<T = Models.PropertyKeys>(parameters: Parameters.GetCommentPropertyKeys | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns the keys of all the properties of a comment.
     *
     * This operation can be accessed anonymously.
     ...
     * - If the comment has visibility restrictions, belongs to the group or has the role visibility is restricted to.
     */
    getCommentPropertyKeys<T = Models.PropertyKeys>(parameters: Parameters.GetCommentPropertyKeys | string, callback?: never): Promise<T>;
    /**
     ...
     * - If the comment has visibility restrictions, belongs to the group or has the role visibility is restricted to.
     */
    getCommentProperty<T = Models.EntityProperty>(parameters: Parameters.GetCommentProperty, callback: Callback<T>): Promise<void>;
    /**
     * Returns the value of a comment property.
     *
     * This operation can be accessed anonymously.
     ...
     * - If the comment has visibility restrictions, belongs to the group or has the role visibility is restricted to.
     */
    getCommentProperty<T = Models.EntityProperty>(parameters: Parameters.GetCommentProperty, callback?: never): Promise<T>;
    /**
     ...
     * group.
     */
    setCommentProperty<T = unknown>(parameters: Parameters.SetCommentProperty, callback: Callback<T>): Promise<void>;
    /**
     * Creates or updates the value of a property for a comment. Use this resource to store custom data against a comment.
     *
     * The value of the request body must be a [valid](http://tools.ietf.org/html/rfc4627), non-empty JSON blob. The
     ...
     * group.
     */
    setCommentProperty<T = unknown>(parameters: Parameters.SetCommentProperty, callback?: never): Promise<T>;
    /**
     ...
     * group.
     */
    deleteCommentProperty<T = void>(parameters: Parameters.DeleteCommentProperty, callback: Callback<T>): Promise<void>;
    /**
     * Deletes a comment property.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** either
     ...
     * group.
     */
    deleteCommentProperty<T = void>(parameters: Parameters.DeleteCommentProperty, callback?: never): Promise<T>;
}
