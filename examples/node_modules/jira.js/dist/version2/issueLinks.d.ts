...
export declare class IssueLinks {
     ...
     *   issues.
     */
    getIssueLink<T = Models.IssueLink>(parameters: Parameters.GetIssueLink | string, callback: Callback<T>): Promise<void>;
    /**
     * Returns an issue link.
     *
     * This operation can be accessed anonymously.
     ...
     *   issues.
     */
    getIssueLink<T = Models.IssueLink>(parameters: Parameters.GetIssueLink | string, callback?: never): Promise<T>;
    /**
     ...
     *   issues.
     */
    deleteIssueLink<T = void>(parameters: Parameters.DeleteIssueLink | string, callback: Callback<T>): Promise<void>;
    /**
     * Deletes an issue link.
     *
     * This operation can be accessed anonymously.
     ...
     *   issues.
     */
    deleteIssueLink<T = void>(parameters: Parameters.DeleteIssueLink | string, callback?: never): Promise<T>;
}
