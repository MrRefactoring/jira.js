...
export async function createFixtures(
  ...
  cleanup.push(() => assets.objectSchemas.deleteSchema({ id: String(schema.id) }));
  ...
  cleanup.push(() => assets.objectTypes.deleteObjectType({ id: String(objectType.id) }));
  ...
  cleanup.push(() => assets.objects.deleteObject({ id: String(object.id) }));
