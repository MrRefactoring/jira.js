...
export const GetFieldsPaginatedSchema = z.object({
  ...
  /**
   * [Order](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro#ordering) the results by:
   *
...
export type GetFieldsPaginated = z.input<typeof GetFieldsPaginatedSchema>;
