import { z } from 'zod';
import { StringListSchema } from '../models';
...
export const SearchProjectsSchema = z.object({
   ...
   */
  typeKey: z.union([z.string(), z.array(z.string())]).optional(),
  /**
  ...
  expand: z
    .union([
      z.string(),
      z.array(z.string()),
      z.enum(['description', 'projectKeys', 'lead', 'issueTypes', 'url', 'insight']),
      z.array(z.enum(['description', 'projectKeys', 'lead', 'issueTypes', 'url', 'insight'])),
    ])
    .optional(),
  /**
...
export type SearchProjects = z.input<typeof SearchProjectsSchema>;
