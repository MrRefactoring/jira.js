import { z } from 'zod';
import { CreateWorkflowConditionSchema } from '#/models/createWorkflowCondition';
import { CreateWorkflowTransitionRuleSchema } from '#/models/createWorkflowTransitionRule';
