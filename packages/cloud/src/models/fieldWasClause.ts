import { z } from 'zod';
import { JqlQueryFieldSchema } from '#/models/jqlQueryField';
import { JqlQueryClauseOperandSchema } from '#/models/jqlQueryClauseOperand';
import { JqlQueryClauseTimePredicateSchema } from '#/models/jqlQueryClauseTimePredicate';
