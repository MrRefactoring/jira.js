import { z } from 'zod';
import { GetFieldAssociationSchemeResponseSchema } from '#/models/getFieldAssociationSchemeResponse';

/** A page of items. */
export const Page2GetFieldAssociationSchemeResponseSchema = z.object({
