import { z } from 'zod';
import { CustomTemplatesProjectDetailsSchema } from '#/models/customTemplatesProjectDetails';
import { CustomTemplateRequestDTOSchema } from '#/models/customTemplateRequestDTO';
