import { z } from 'zod';
import { StatusPayloadSchema } from '#/models/statusPayload';
import { WorkflowSchemePayloadSchema } from '#/models/workflowSchemePayload';
import { WorkflowPayloadSchema } from '#/models/workflowPayload';
