import { z } from 'zod';
import { CustomFieldContextProjectMappingSchema } from '#/models/customFieldContextProjectMapping';

/** A page of items. */
export const PageCustomFieldContextProjectMappingSchema = z.object({
