import { z } from 'zod';
import { VersionApproverSchema } from '#/models/versionApprover';
import { VersionIssuesStatusSchema } from '#/models/versionIssuesStatus';
import { SimpleLinkSchema } from '#/models/simpleLink';
