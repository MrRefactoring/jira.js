import { z } from 'zod';
import { CreateWorkflowStatusDetailsSchema } from '#/models/createWorkflowStatusDetails';
import { CreateWorkflowTransitionDetailsSchema } from '#/models/createWorkflowTransitionDetails';
