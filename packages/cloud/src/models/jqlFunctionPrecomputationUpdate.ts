...
export const JqlFunctionPrecomputationUpdateSchema = z.object({
  /**
...
export type JqlFunctionPrecomputationUpdate = z.infer<typeof JqlFunctionPrecomputationUpdateSchema>;
