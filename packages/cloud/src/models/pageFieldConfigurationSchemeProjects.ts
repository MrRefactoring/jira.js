import { z } from 'zod';
import { FieldConfigurationSchemeProjectsSchema } from '#/models/fieldConfigurationSchemeProjects';

/** A page of items. */
export const PageFieldConfigurationSchemeProjectsSchema = z.object({
