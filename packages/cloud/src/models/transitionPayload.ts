import { z } from 'zod';
import { RulePayloadSchema } from '#/models/rulePayload';
import { ConditionGroupPayloadSchema } from '#/models/conditionGroupPayload';
import { FromLayoutPayloadSchema } from '#/models/fromLayoutPayload';
import { ToLayoutPayloadSchema } from '#/models/toLayoutPayload';
