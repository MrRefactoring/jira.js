import { z } from 'zod';
import { RequiredMappingByIssueTypeSchema } from '#/models/requiredMappingByIssueType';
import { RequiredMappingByWorkflowsSchema } from '#/models/requiredMappingByWorkflows';
import { StatusMetadataSchema } from '#/models/statusMetadata';
import { StatusesPerWorkflowSchema } from '#/models/statusesPerWorkflow';
