import { z } from 'zod';
import { MappingsByIssueTypeOverrideSchema } from '#/models/mappingsByIssueTypeOverride';

/** Request to switch a project's workflow scheme */
export const WorkflowSchemeProjectSwitchSchema = z.object({
  /**
   ...
   */
  mappingsByIssueTypeOverride: z.array(MappingsByIssueTypeOverrideSchema).optional(),
  /** The ID of the project to switch the workflow scheme for */
  projectId: z.string().optional(),
  /** The ID of the target workflow scheme to switch to */
  targetSchemeId: z.string().optional(),
});

export type WorkflowSchemeProjectSwitch = z.infer<typeof WorkflowSchemeProjectSwitchSchema>;
