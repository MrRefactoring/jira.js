import { z } from 'zod';
import { IssueSecuritySchemeToProjectMappingSchema } from '#/models/issueSecuritySchemeToProjectMapping';

/** A page of items. */
export const PageIssueSecuritySchemeToProjectMappingSchema = z.object({
