import { z } from 'zod';
import { NotificationSchemeAndProjectMappingJsonSchema } from '#/models/notificationSchemeAndProjectMappingJson';

/** A page of items. */
export const NotificationSchemeAndProjectMappingPageSchema = z.object({
