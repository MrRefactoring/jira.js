import { z } from 'zod';
import { JsonNodeSchema } from '#/models/jsonNode';

/** Details about a task. */
export const TaskProgressJsonNodeSchema = z.object({
...
export type TaskProgressJsonNode = z.infer<typeof TaskProgressJsonNodeSchema>;
