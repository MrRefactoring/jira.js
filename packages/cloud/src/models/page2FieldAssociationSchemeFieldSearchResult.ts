import { z } from 'zod';
import { FieldAssociationSchemeFieldSearchResultSchema } from '#/models/fieldAssociationSchemeFieldSearchResult';

/** A page of items. */
export const Page2FieldAssociationSchemeFieldSearchResultSchema = z.object({
