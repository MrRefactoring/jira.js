...
export const CreatePriorityDetailsSchema = z.object({
  ...
  description: z.string().max(255, 'description must be at most 255 characters').nullable().optional(),
  /**
...
export type CreatePriorityDetails = z.infer<typeof CreatePriorityDetailsSchema>;
