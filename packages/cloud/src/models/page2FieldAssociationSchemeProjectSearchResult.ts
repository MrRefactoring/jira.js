import { z } from 'zod';
import { FieldAssociationSchemeProjectSearchResultSchema } from '#/models/fieldAssociationSchemeProjectSearchResult';

/** A page of items. */
export const Page2FieldAssociationSchemeProjectSearchResultSchema = z.object({
