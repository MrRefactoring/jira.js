import { z } from 'zod';
import { UiModificationContextDetailsSchema } from '#/models/uiModificationContextDetails';
...
export type UpdateUiModificationDetails = z.infer<typeof UpdateUiModificationDetailsSchema>;
