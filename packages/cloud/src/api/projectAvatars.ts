...
import { ProjectAvatarsSchema, type ProjectAvatars } from '#/models/projectAvatars';
 ...
 *
 * Use [Load project
 * avatar](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-project/#api-rest-api-3-project-projectIdOrKey-avatar2-post)
 * to store avatars against the project, before using this operation to set the displayed avatar.
 *
