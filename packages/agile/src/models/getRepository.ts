  ...
  branches: z
    .array(
      z.object({
        ...
        createPullRequestUrl: z.string().max(2000, 'createPullRequestUrl must be at most 2000 characters').optional(),
  ...
  pullRequests: z
    .array(
      z.object({
        ...
        destinationBranchUrl: z.string().max(2000, 'destinationBranchUrl must be at most 2000 characters').optional(),
