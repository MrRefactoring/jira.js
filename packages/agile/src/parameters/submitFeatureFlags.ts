    ...
    z.object({
      ...
      details: z.array(
        z.object({
           ...
           *
           * Ideally there is also type information which may be used to group data from multiple Feature Flags and
...
export type SubmitFeatureFlags = z.input<typeof SubmitFeatureFlagsSchema>;
