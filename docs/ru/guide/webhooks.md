...
Стоит знать, прежде чем доверять полю: **Атлассиан публикует одно полное тело** — для событий задачи. Про остальные
...
`filter`. Сверить их с документацией Атлассиана было не с чем, поэтому тип заставляет вас проверить, и в объявлении это
