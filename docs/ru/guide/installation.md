...
`jira.js/server`, `jira.js/serviceDeskServer`, `jira.js/assetsServer` и `jira.js/core`, — в которых лежат плоские функции вместе со всеми типами параметров и ответов. См.
