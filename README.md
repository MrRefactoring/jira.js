...
**Jira.js** is a TypeScript client for the Atlassian Jira REST APIs — Jira Cloud and self-hosted Jira Data Center — for [Node.js](https://nodejs.org/) and browsers. It covers eight surfaces:
