...
| `jira.js/userManagement` | User management functions, parameters and response types |
| `jira.js/userProvisioning` | SCIM provisioning functions, parameters and response types |
