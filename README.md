...
**Jira.js** is a TypeScript client for the Atlassian Jira REST APIs — Jira Cloud and self-hosted Jira Data Center — for [Node.js](https://nodejs.org/) and browsers. It covers eleven surfaces, in eight groups:
...
The eleven surfaces are not re-exported from the root — they collide on a handful of names, so import from the one you mean.
