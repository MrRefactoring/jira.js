  ...
  repositories?: {
    ...
    branches?: {
      ...
      lastCommit: {
        ...
        id: string;
        /**
         * List of issues keys that this entity is associated with. They must be valid Jira issue keys. Minimum number
         * of issue keys is 1. Maximum number of issue keys is 100.
         */
        issueKeys: string[];
        /**
         * An ID used to apply an ordering to updates for this entity in the case of out-of-order receipt of update
        ...
        author: {
          ...
          email?: string;
          /**
           * The username of the user. Used to associate the user with a Jira user if there are multiple users for a
           * given email. Max length is 255 characters.
           */
          username?: string;
          /** The URL of the profile for this user. Max length is 1024 characters. */
          url?: string;
