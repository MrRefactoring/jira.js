import { ScimSchemaDocumentSchema, type ScimSchemaDocument } from '../models/scimSchemaDocument';
...
): Promise<ScimSchemaDocument> {
  const config: SendRequestOptions<ScimSchemaDocument> = {
    url: `/scim/directory/${parameters.directoryId}/Schemas`,
    method: 'GET',
    schema: ScimSchemaDocumentSchema,
