import { type ClientConfig, type RequestOptions, ATLASSIAN_GATEWAY, createClient } from '#/core';
...
export function createUserProvisioningClient(config: UserProvisioningClientConfig) {
  ...
  return {
    ...
    schemas: {
      getSchemas: (parameters: GetSchemas, options?: RequestOptions): Promise<ScimSchemaDocument> =>
        schemas.getSchemas(client, parameters, options),
      getUserSchemas: (parameters: GetUserSchemas, options?: RequestOptions): Promise<ScimSchemaDocument> =>
        schemas.getUserSchemas(client, parameters, options),
      getGroupSchemas: (parameters: GetGroupSchemas, options?: RequestOptions): Promise<ScimSchemaDocument> =>
        schemas.getGroupSchemas(client, parameters, options),
      getExtensionUserSchemas: (
        parameters: GetExtensionUserSchemas,
        options?: RequestOptions,
      ): Promise<ScimSchemaDocument> => schemas.getExtensionUserSchemas(client, parameters, options),
    },
    serviceProviderConfiguration: {
      getResourceTypes: (parameters: GetResourceTypes, options?: RequestOptions): Promise<ScimConfigurationDocument> =>
