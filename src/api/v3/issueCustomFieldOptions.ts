...
import { PageBeanCustomFieldContextOption as PageBeanCustomFieldContextOptionResponse, PageBeanCustomFieldOptionDetails as PageBeanCustomFieldOptionDetailsResponse, CustomFieldOption as CustomFieldOptionResponse } from '../../models/v3';
...
export class IssueCustomFieldOptions {
  ...
  async getOptionsForContext(parameters: {
    ...
    const request: AxiosRequestConfig = {
      url: `/rest/api/3/customField/${parameters.fieldId}/context/${parameters.contextId}/option`,
      method: 'GET',
    };
  ...
  async reorderCustomFieldOptions(parameters: {
    ...
    const request: AxiosRequestConfig = {
      url: `/rest/api/3/customField/${parameters.fieldId}/context/${parameters.contextId}/option/move`,
      method: 'PUT',
    };
  ...
  async deleteCustomFieldOption(parameters: {
    ...
    const request: AxiosRequestConfig = {
      url: `/rest/api/3/customField/${parameters.fieldId}/context/${parameters.contextId}/option/${parameters.optionId}`,
      method: 'DELETE',
    };
