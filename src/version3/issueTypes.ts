...
export class IssueTypes {
  ...
  async getIssueAllTypes<T = Models.IssueTypeDetails[]>(callback?: Callback<T>): Promise<void | T> {
    ...
    return this.client.sendRequest(config, callback, { methodName: 'version3.issueTypes.getIssueAllTypes' });
  }
  ...
  async getIssueType<T = Models.IssueTypeDetails>(
    ...
    return this.client.sendRequest(config, callback, { methodName: 'version3.issueTypes.getIssueType' });
  }
  ...
  async updateIssueType<T = Models.IssueTypeDetails>(
    ...
    return this.client.sendRequest(config, callback, { methodName: 'version3.issueTypes.updateIssueType' });
  }
  ...
  async deleteIssueType<T = void>(parameters: Parameters.DeleteIssueType, callback?: Callback<T>): Promise<void | T> {
    ...
    return this.client.sendRequest(config, callback, { methodName: 'version3.issueTypes.deleteIssueType' });
  }
  ...
  async getAlternativeIssueTypes<T = Models.IssueTypeDetails[]>(
    ...
    return this.client.sendRequest(config, callback, { methodName: 'version3.issueTypes.getAlternativeIssueTypes' });
  }
  ...
  async createIssueTypeAvatar<T = Models.Avatar>(
    ...
    return this.client.sendRequest(config, callback, { methodName: 'version3.issueTypes.createIssueTypeAvatar' });
  }
}
