export interface GetFieldsPaginated {
   ...
   * the field last changed. `name` Sorts by the field name. `screensCount` Sorts by the number of screens related to a
   * field.
   */
  orderBy?: string;
  /**
   ...
   * related to a field. `isLocked` Returns information about whether the field is
   * [locked](https://confluence.atlassian.com/x/ZSN7Og). `searcherKey` Returns the searcher key for each custom field.
   */
  expand?: string;
}
