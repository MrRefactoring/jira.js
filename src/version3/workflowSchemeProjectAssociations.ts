...
export class WorkflowSchemeProjectAssociations {
  ...
  /**
   * @deprecated Use 'assignSchemeToProject' Assigns a workflow scheme to a project. This operation is performed only
   *   when there are no issues in the project. Workflow schemes can only be assigned to classic projects.
   *   **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:**
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
