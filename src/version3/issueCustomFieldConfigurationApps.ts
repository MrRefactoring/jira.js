...
export class IssueCustomFieldConfigurationApps {
  ...
  /**
   * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#pagination) list of configurations for a custom field. The result can be filtered by
   * `contextId` or `issueId`, otherwise all configurations are returned. Invalid IDs are ignored.
   *
   * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v3/intro/#permissions) required:** *Administer Jira* [global
