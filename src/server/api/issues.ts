import { PartialSuccessSchema, type PartialSuccess } from '../models/partialSuccess';
...
import { PageCreateMetaIssueTypeSchema } from '../models/pageCreateMetaIssueType';
import type { Page } from '../models/page';
import type { CreateMetaIssueType } from '../models/createMetaIssueType';
import { PageFieldMetaSchema } from '../models/pageFieldMeta';
import type { FieldMeta } from '../models/fieldMeta';
...
export async function getCreateIssueMetaProjectIssueTypes(
  ...
  options?: RequestOptions,
): Promise<Page<CreateMetaIssueType>> {
  const config: SendRequestOptions<Page<CreateMetaIssueType>> = {
    ...
    schema: PageCreateMetaIssueTypeSchema,
    signal: options?.signal,
  };
...
export async function getCreateIssueMetaFields(
  ...
  options?: RequestOptions,
): Promise<Page<FieldMeta>> {
  const config: SendRequestOptions<Page<FieldMeta>> = {
...
export async function canMoveSubTask(
  ...
  const config: SendRequestOptions<boolean> = {
