...
import { PagePriorityJsonSchema } from '../models/pagePriorityJson';
...
): Promise<Page<PriorityJson>> {
  const config: SendRequestOptions<Page<PriorityJson>> = {
