...
import { PageStatusJsonSchema } from '../models/pageStatusJson';
...
): Promise<Page<StatusJson>> {
  const config: SendRequestOptions<Page<StatusJson>> = {
