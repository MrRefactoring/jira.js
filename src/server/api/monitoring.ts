...
export async function areMetricsExposed(client: Client, options?: RequestOptions): Promise<boolean> {
...
export async function getAvailableMetrics(client: Client, options?: RequestOptions): Promise<string[]> {
