 ...
 * user and related password are created, using methods like the ones in <a
 * href="https://docs.atlassian.com/jira/latest/com/atlassian/jira/bc/user/UserService.html">UserService</a>. For
 * example, you could use this to validate a password in a create user form in the user interface, as the user enters
 * it. The username and new password must be not empty to perform the validation. Note, this method will help you
