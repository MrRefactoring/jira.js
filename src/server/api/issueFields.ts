import { PageCustomFieldSchema } from '../models/pageCustomField';
...
): Promise<Page<CustomField>> {
  const config: SendRequestOptions<Page<CustomField>> = {
