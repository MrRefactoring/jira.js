 ...
 */
export async function getPermissions(client: Client, parameters?: GetPermissions): Promise<PermissionsJson> {
...
export async function getAllPermissions(client: Client): Promise<PermissionsJson> {
  const config: SendRequestOptions<PermissionsJson> = {
