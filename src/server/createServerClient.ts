...
import type { AuthBasic, AuthBearer, AuthOAuth2Server } from '#/core';
...
export type ServerClientConfig = Omit<ClientConfig, 'auth' | 'host'> & {
...
export function createServerClient(clientConfig: ServerClientConfig | Client) {
  ...
  return {
    ...
    issues: {
      ...
      getCreateIssueMetaProjectIssueTypes: (
        ...
        options?: RequestOptions,
      ): Promise<Page<CreateMetaIssueType>> => issues.getCreateIssueMetaProjectIssueTypes(client, parameters, options),
      getCreateIssueMetaFields: (
        parameters: GetCreateIssueMetaFields,
        options?: RequestOptions,
      ): Promise<Page<FieldMeta>> => issues.getCreateIssueMetaFields(client, parameters, options),
      getIssuePickerResource: (
      ...
      canMoveSubTask: (parameters: CanMoveSubTask, options?: RequestOptions): Promise<boolean> =>
    ...
    issueFields: {
      getCustomFields: (parameters?: GetCustomFields, options?: RequestOptions): Promise<Page<CustomField>> =>
    ...
    indexing: {
      ...
      processRequests: (options?: RequestOptions): Promise<number[]> => indexing.processRequests(client, options),
      getProgressBulk: (parameters?: GetProgressBulk, options?: RequestOptions): Promise<unknown> =>
    ...
    issueTypes: {
      ...
      getPaginatedIssueTypes: (
        ...
        options?: RequestOptions,
      ): Promise<Page<IssueTypeJson>> => issueTypes.getPaginatedIssueTypes(client, parameters, options),
    ...
    monitoring: {
      ...
      areMetricsExposed: (options?: RequestOptions): Promise<boolean> => monitoring.areMetricsExposed(client, options),
      getAvailableMetrics: (options?: RequestOptions): Promise<string[]> =>
    ...
    password: {
      getPasswordPolicy: (parameters?: GetPasswordPolicy, options?: RequestOptions): Promise<string[]> =>
        password.getPasswordPolicy(client, parameters, options),
      policyCheckCreateUser: (parameters: PolicyCheckCreateUser, options?: RequestOptions): Promise<string[]> =>
        password.policyCheckCreateUser(client, parameters, options),
      policyCheckUpdateUser: (parameters: PolicyCheckUpdateUser, options?: RequestOptions): Promise<string[]> =>
    ...
    issuePriorities: {
      ...
      getPrioritiesPaginated: (
        ...
        options?: RequestOptions,
      ): Promise<Page<PriorityJson>> => issuePriorities.getPrioritiesPaginated(client, parameters, options),
    ...
    issueResolutions: {
      ...
      getPaginatedResolutions: (
        ...
        options?: RequestOptions,
      ): Promise<Page<ResolutionJson>> => issueResolutions.getPaginatedResolutions(client, parameters, options),
    ...
    searchLimits: {
      ...
      getMaxResultWindow: (options?: RequestOptions): Promise<number> =>
    ...
    workflowStatuses: {
      ...
      getPaginatedStatuses: (parameters?: GetPaginatedStatuses, options?: RequestOptions): Promise<Page<StatusJson>> =>
