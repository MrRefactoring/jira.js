...
import { FilterRegistrationSchema } from './filterRegistration';
import { JspConfigDescriptorSchema } from './jspConfigDescriptor';
import { ServletRegistrationSchema } from './servletRegistration';
...
export const ServletContextSchema = apiObject({
  ...
  filterRegistrations: z.record(z.string(), FilterRegistrationSchema).optional(),
  ...
  servletRegistrations: z.record(z.string(), ServletRegistrationSchema).optional(),
