...
export const GetCustomerRequestsSchema = z.object({
  /**
   ...
   */
  requestOwnership: z.array(z.string()).optional(),
  /**
...
export type GetCustomerRequests = z.input<typeof GetCustomerRequestsSchema>;
