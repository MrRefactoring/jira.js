...
export * from './addCustomersSkippingPermissionCheck';
...
export * from './createCommentWithAttachment';

export * from './createCustomer';

export * from './createCustomerRequest';

export * from './createCustomerSkippingPermissionCheck';
...
export * from './getAssetsWorkspaces';
...
export * from './getServiceDeskArticles';

export * from './getServiceDeskById';

export * from './getServiceDeskOrganizations';
...
export * from './revokePortalOnlyAccessForUser';
