...
export class RequestType {
  ...
  /**
   * This method returns all customer request types used in the Jira Service Management instance, optionally filtered
   * by a query string.
   *
   ...
   * against the customer request types' `name` or `description`. For example, searching for "Install", "Inst",
   * "Equi", or "Equipment" will match a customer request type with the *name* "Equipment Installation Request".
   *
