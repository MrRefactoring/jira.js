...
import {
  PageOfCreateMetaIssueTypesSchema,
  type PageOfCreateMetaIssueTypes,
} from '../models/pageOfCreateMetaIssueTypes';
import {
...
export async function createIssue(
  ...
  if (typeof parameters.fields?.description === 'string' || typeof parameters.fields?.environment === 'string') {
    return client.sendRequest({
      ...
      method: 'POST',
      searchParams: { updateHistory: parameters.updateHistory },
      body: {
 ...
 *
 * **Note:** This endpoint doesn't check screen configurations to determine if a field is editable. For more context,
 * see the [Deprecation of override screen
 * security](https://community.developer.atlassian.com/t/deprecation-of-override-screen-security/97153) announcement.
 *
