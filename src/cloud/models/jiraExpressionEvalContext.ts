...
import { CustomContextVariableSchema } from './customContextVariable';
import { IdOrKeySchema } from './idOrKey';
import { JexpIssuesSchema } from './jexpIssues';

export const JiraExpressionEvalContextSchema = apiObject({
...
export type JiraExpressionEvalContext = z.infer<typeof JiraExpressionEvalContextSchema>;
