...
export const JqlFunctionPrecomputationSchema = apiObject({
  ...
  used: z.coerce.date().optional(),
  /** The JQL fragment stored as the precomputation. */
  value: z.string().optional(),
});

export type JqlFunctionPrecomputation = z.infer<typeof JqlFunctionPrecomputationSchema>;
