...
export const SharePermissionInputSchema = apiObject({
   ...
   * - `global` Share globally, including anonymous users. If set, this type overrides all existing share permissions
   *   and must be deleted before any non-global share permissions is set.
