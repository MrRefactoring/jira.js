...
export const ComponentWithIssueCountSchema = apiObject({
   ...
   * - `PROJECT_DEFAULT` the assignee to any issues created with this component is nominally the default assignee for
  ...
  self: z.url().optional(),
  componentBean: z.record(z.string(), z.any()).optional(),
});
