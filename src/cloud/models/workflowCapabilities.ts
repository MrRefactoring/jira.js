...
export const WorkflowCapabilitiesSchema = apiObject({
   ...
   * projects.
   */
  editorScope: openEnum(['PROJECT', 'GLOBAL']).optional(),
  ...
  projectTypes: z.array(openEnum(['software', 'service_desk', 'product_discovery', 'business', 'unknown'])).optional(),
