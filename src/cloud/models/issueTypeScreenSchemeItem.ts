...
export const IssueTypeScreenSchemeItemSchema = apiObject({
   ...
   * issue screen scheme, an entry for _default_ must be provided and defines the mapping for all issue types without
   * a screen scheme. Otherwise, a _default_ entry can't be provided.
   */
