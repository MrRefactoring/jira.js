...
export const MultipleCustomFieldValuesUpdateSchema = apiObject({
...
export type MultipleCustomFieldValuesUpdate = z.infer<typeof MultipleCustomFieldValuesUpdateSchema>;
