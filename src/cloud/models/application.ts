...
export const ApplicationSchema = apiObject({
   ...
   * tooltip title. If both items are blank, the icon tooltop displays as "Web Link". Grouping and sorting of links
   * may place links without an application name last.
   */
