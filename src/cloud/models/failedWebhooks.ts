...
export const FailedWebhooksSchema = apiObject({
  /**
   * The maximum number of items on the page. If the list of values is shorter than this number, then there are no
   * more pages.
   */
  maxResults: z.number(),
  /**
   * The URL to the next page of results. Present only if the request returned at least one result.The next page may
