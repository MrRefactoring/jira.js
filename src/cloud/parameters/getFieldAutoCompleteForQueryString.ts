...
export const GetFieldAutoCompleteForQueryStringSchema = z.object({
   ...
   * predicate](https://confluence.atlassian.com/x/hQORLQ#Advancedsearching-operatorsreference-CHANGEDCHANGED) for
   * which the suggestions are generated. The valid predicate operators are _by_, _from_, and _to_.
   */
