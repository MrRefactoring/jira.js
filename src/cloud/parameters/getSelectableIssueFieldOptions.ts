...
export const GetSelectableIssueFieldOptionsSchema = z.object({
...
export type GetSelectableIssueFieldOptions = z.input<typeof GetSelectableIssueFieldOptionsSchema>;
