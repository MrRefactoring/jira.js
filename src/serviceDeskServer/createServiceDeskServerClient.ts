...
export type ServiceDeskServerClientConfig = Omit<ClientConfig, 'auth' | 'host'> & {
...
export function createServiceDeskServerClient(clientConfig: ServiceDeskServerClientConfig | Client) {
  ...
  return {
    ...
    organizations: {
      ...
      cleanUpOrganizations: (parameters: CleanUpOrganizations, options?: RequestOptions): Promise<number> =>
