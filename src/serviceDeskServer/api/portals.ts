...
export async function getPortal(client: Client, parameters: GetPortal): Promise<Portal> {
...
export async function getPortalByProjectKey(client: Client, parameters: GetPortalByProjectKey): Promise<Portal> {
  const config: SendRequestOptions<Portal> = {
...
export async function getPortals(client: Client, parameters?: GetPortals): Promise<Page<Portal>> {
