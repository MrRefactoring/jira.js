import { z } from 'zod';
import { MultiDirectoryGroupSearchRequestSchema } from '../models';

export const SearchDirectoryGroupsSchema = z.object(MultiDirectoryGroupSearchRequestSchema.shape).extend({
  /**
...
export type SearchDirectoryGroups = z.input<typeof SearchDirectoryGroupsSchema>;
