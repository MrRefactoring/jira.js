...
export const RevokeOrganizationRoleSchema = z.object(OrganizationLevelRoleApiRequestSchema.shape).extend({
  /**
...
export type RevokeOrganizationRole = z.input<typeof RevokeOrganizationRoleSchema>;
