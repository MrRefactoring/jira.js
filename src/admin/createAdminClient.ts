...
export function createAdminClient(config: AdminClientConfig) {
  ...
  return {
    ...
    users: {
      ...
      /**
       * @deprecated **This API is deprecated and will no longer work after June 30, 2027.** Use the [Search for users
       *   in an organization
    ...
    groups: {
      ...
      /**
       * @deprecated **This API is deprecated and will no longer work after June 30, 2027.** Use the [Search for groups
       *   in an organization
