import { type Page, type Organization, OrganizationSchema, PageSchema, DataSchema } from '../responses';
...
export class Organizations {
   ...
   *
   * @param id Your organization is identified by a Unique ID. You get your organization ID and Organization API key
   *   simultaneously.
   */
