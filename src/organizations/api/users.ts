...
export class Users {
  ...
  /**
   * The API is available for customers using the new user management experience only. [How the new user management
   * experience
   ...
   *
   * Returns a list of users within an organization, offering search functionality through multiple parameters for more
   * precise results.
   */
  async searchUsers() {}
