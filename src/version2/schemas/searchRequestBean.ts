...
export const SearchRequestBeanSchema = z.object({
   ...
   * - `true` _Deprecated_ A legacy synonym for `strict`.
   * - `false` _Deprecated_ A legacy synonym for `warn`.
   *
...
export type SearchRequestBean = z.infer<typeof SearchRequestBeanSchema>;
