...
export const IconSchema = z.object({
   ...
   *   Jira.
   * - For the remote object icon it is used in conjunction with the application name to display a tooltip for the link's
   *   icon. The tooltip takes the format "[application name] icon title". Blank itemsare excluded from the tooltip
