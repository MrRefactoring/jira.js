...
export const GetPermissionSchemeGrantParametersSchema = z.object({
...
export type GetPermissionSchemeGrantParameters = z.infer<typeof GetPermissionSchemeGrantParametersSchema>;
