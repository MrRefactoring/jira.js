...
export const DeleteFavouriteForFilterParametersSchema = z.object({
...
export type DeleteFavouriteForFilterParameters = z.infer<typeof DeleteFavouriteForFilterParametersSchema>;
