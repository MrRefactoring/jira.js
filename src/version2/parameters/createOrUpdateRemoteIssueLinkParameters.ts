...
export const CreateOrUpdateRemoteIssueLinkParametersSchema = z.object({
...
export type CreateOrUpdateRemoteIssueLinkParameters = z.infer<typeof CreateOrUpdateRemoteIssueLinkParametersSchema>;
