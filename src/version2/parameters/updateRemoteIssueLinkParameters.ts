...
export const UpdateRemoteIssueLinkParametersSchema = z.object({
...
export type UpdateRemoteIssueLinkParameters = z.infer<typeof UpdateRemoteIssueLinkParametersSchema>;
