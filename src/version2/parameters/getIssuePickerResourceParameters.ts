...
export const GetIssuePickerResourceParametersSchema = z.object({
...
export type GetIssuePickerResourceParameters = z.infer<typeof GetIssuePickerResourceParametersSchema>;
