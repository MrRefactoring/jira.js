...
export const SetActorsParametersSchema = z.object({
   ...
   */
  categorisedActors: z.object({}).optional(),
  /**
   * The ID of the project role. Use [Get all project roles](#api-rest-api-2-role-get) to get a list of project role
   * IDs.
   */
...
export type SetActorsParameters = z.infer<typeof SetActorsParametersSchema>;
