...
export const CreatePermissionSchemeParametersSchema = z.object({
  /**
...
export type CreatePermissionSchemeParameters = z.infer<typeof CreatePermissionSchemeParametersSchema>;
