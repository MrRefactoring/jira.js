...
export const ReplaceIssueFieldOptionParametersSchema = z.object({
...
export type ReplaceIssueFieldOptionParameters = z.infer<typeof ReplaceIssueFieldOptionParametersSchema>;
