...
export const BulkSetIssuePropertyParametersSchema = z.object({
...
export type BulkSetIssuePropertyParameters = z.infer<typeof BulkSetIssuePropertyParametersSchema>;
