...
export const GetIssueSecurityLevelMembersParametersSchema = z.object({
  /**
   ...
   */
  issueSecuritySchemeId: z.number().int(),
...
export type GetIssueSecurityLevelMembersParameters = z.infer<typeof GetIssueSecurityLevelMembersParametersSchema>;
