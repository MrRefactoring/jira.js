...
export const CreateCustomFieldParametersSchema = z.object({
   ...
   * - `multiversion`: Stores multiple versions from the versions available in a project using a picker control (value:
...
export type CreateCustomFieldParameters = z.infer<typeof CreateCustomFieldParametersSchema>;
