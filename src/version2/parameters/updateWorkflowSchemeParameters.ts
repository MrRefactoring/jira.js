...
export const UpdateWorkflowSchemeParametersSchema = z.object({
  /**
...
export type UpdateWorkflowSchemeParameters = z.infer<typeof UpdateWorkflowSchemeParametersSchema>;
