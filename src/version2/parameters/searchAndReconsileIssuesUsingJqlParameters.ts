...
export const SearchAndReconsileIssuesUsingJqlParametersSchema = z.object({
  /**
...
export type SearchAndReconsileIssuesUsingJqlParameters = z.infer<
  typeof SearchAndReconsileIssuesUsingJqlParametersSchema
>;
