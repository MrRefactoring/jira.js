...
export const DeleteAndReplaceVersionParametersSchema = z.object({
...
export type DeleteAndReplaceVersionParameters = z.infer<typeof DeleteAndReplaceVersionParametersSchema>;
