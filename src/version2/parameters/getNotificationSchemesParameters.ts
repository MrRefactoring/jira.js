...
export const GetNotificationSchemesParametersSchema = z.object({
...
export type GetNotificationSchemesParameters = z.infer<typeof GetNotificationSchemesParametersSchema>;
