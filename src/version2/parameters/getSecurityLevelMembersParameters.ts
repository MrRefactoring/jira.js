...
export const GetSecurityLevelMembersParametersSchema = z.object({
...
export type GetSecurityLevelMembersParameters = z.infer<typeof GetSecurityLevelMembersParametersSchema>;
