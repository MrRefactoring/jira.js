...
export const FindUsersWithAllPermissionsParametersSchema = z.object({
  /**
...
export type FindUsersWithAllPermissionsParameters = z.infer<typeof FindUsersWithAllPermissionsParametersSchema>;
