export interface SearchAndReconsileIssuesUsingJql {
   ...
   *
   * `*all` Returns all fields. `*navigable` Returns navigable fields. `id` Returns only issue IDs. Any issue field,
   ...
   *     Examples:
   *
   * `summary,comment` Returns only the summary and comments fields only. `-description` Returns all navigable
   * (default) fields except description. `*all,-comment` Returns all fields except comments.
   *
