...
export const GetNotificationSchemeParametersSchema = z.object({
  /**
...
export type GetNotificationSchemeParameters = z.infer<typeof GetNotificationSchemeParametersSchema>;
