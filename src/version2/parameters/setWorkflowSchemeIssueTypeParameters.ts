...
export const SetWorkflowSchemeIssueTypeParametersSchema = z.object({
...
export type SetWorkflowSchemeIssueTypeParameters = z.infer<typeof SetWorkflowSchemeIssueTypeParametersSchema>;
