...
export const GetSelectableIssueFieldOptionsParametersSchema = z.object({
...
export type GetSelectableIssueFieldOptionsParameters = z.infer<typeof GetSelectableIssueFieldOptionsParametersSchema>;
