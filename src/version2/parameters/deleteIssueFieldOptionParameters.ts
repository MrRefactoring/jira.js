...
export const DeleteIssueFieldOptionParametersSchema = z.object({
  /**
...
export type DeleteIssueFieldOptionParameters = z.infer<typeof DeleteIssueFieldOptionParametersSchema>;
