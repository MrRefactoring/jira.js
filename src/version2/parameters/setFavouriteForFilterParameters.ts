...
export const SetFavouriteForFilterParametersSchema = z.object({
...
export type SetFavouriteForFilterParameters = z.infer<typeof SetFavouriteForFilterParametersSchema>;
