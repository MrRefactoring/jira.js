...
export const GetVisibleIssueFieldOptionsParametersSchema = z.object({
...
export type GetVisibleIssueFieldOptionsParameters = z.infer<typeof GetVisibleIssueFieldOptionsParametersSchema>;
