...
export const GetAssignedPermissionSchemeParametersSchema = z.object({
...
export type GetAssignedPermissionSchemeParameters = z.infer<typeof GetAssignedPermissionSchemeParametersSchema>;
