...
export const UpdatePrioritySchemeParametersSchema = z.object({
...
export type UpdatePrioritySchemeParameters = z.infer<typeof UpdatePrioritySchemeParametersSchema>;
