...
export const CreateWorkflowSchemeParametersSchema = z.object({
  /**
...
export type CreateWorkflowSchemeParameters = z.infer<typeof CreateWorkflowSchemeParametersSchema>;
