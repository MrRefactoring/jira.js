...
export const GetProjectVersionsPaginatedParametersSchema = z.object({
...
export type GetProjectVersionsPaginatedParameters = z.infer<typeof GetProjectVersionsPaginatedParametersSchema>;
