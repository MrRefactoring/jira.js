...
export const GetAllPermissionSchemesParametersSchema = z.object({
  /**
...
export type GetAllPermissionSchemesParameters = z.infer<typeof GetAllPermissionSchemesParametersSchema>;
