...
export const SearchAndReconsileIssuesUsingJqlPostParametersSchema = z.object({
  /**
   ...
   * `id` or `key` only. It returns max 5000 issues.
   */
...
export type SearchAndReconsileIssuesUsingJqlPostParameters = z.infer<
  typeof SearchAndReconsileIssuesUsingJqlPostParametersSchema
>;
