...
export const PartialUpdateProjectRoleParametersSchema = z.object({
  /**
...
export type PartialUpdateProjectRoleParameters = z.infer<typeof PartialUpdateProjectRoleParametersSchema>;
