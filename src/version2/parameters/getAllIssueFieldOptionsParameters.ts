...
export const GetAllIssueFieldOptionsParametersSchema = z.object({
...
export type GetAllIssueFieldOptionsParameters = z.infer<typeof GetAllIssueFieldOptionsParametersSchema>;
