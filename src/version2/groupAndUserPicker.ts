...
export class GroupAndUserPicker {
   ...
   *
   * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** *Browse users and groups* [global permission](https://confluence.atlassian.com/x/yodKLg). */
  ...
  async findUsersAndGroups<T = Models.FoundUsersAndGroups>(parameters: Parameters.FindUsersAndGroups, callback?: Callback<T>): Promise<void | T> {
    ...
    return this.client.sendRequest(config, callback, { methodName: 'version2.groupAndUserPicker.findUsersAndGroups' });
  }
}
