export interface UserWriteBean {
  ...
  /**
   * @deprecated
   * This parameter is no longer available. See the [migration
  ...
  /**
   * @deprecated
   * This parameter is no longer available. If the user has an Atlassian account, their password is not changed. If the
