/** @deprecated Use SharePermissionInput instead. */
export type SharePermissionInputBean = SharePermissionInput;
...
export interface SharePermissionInput {
   ...
   * - `project` Share with a project. Specify `projectId` as well. `projectRole` Share with a project role in a project.
