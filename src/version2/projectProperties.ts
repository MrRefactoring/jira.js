...
import type { GetProjectPropertyKeysParameters } from './parameters/getProjectPropertyKeysParameters';
import type { DeleteProjectPropertyParameters } from './parameters/deleteProjectPropertyParameters';
import type { GetProjectPropertyParameters } from './parameters/getProjectPropertyParameters';
import type { SetProjectPropertyParameters } from './parameters/setProjectPropertyParameters';
...
export class ProjectProperties {
   ...
   */
  async getProjectPropertyKeys(parameters: GetProjectPropertyKeysParameters) {
   ...
   *   [project permission](https://confluence.atlassian.com/x/yodKLg) for the project containing the property.
   */
  async deleteProjectProperty(parameters: DeleteProjectPropertyParameters) {
    const request: Request = {
   ...
   *   property.
   */
  async getProjectProperty(parameters: GetProjectPropertyParameters) {
    const request: Request = {
      url: `/rest/api/2/project/${parameters.projectIdOrKey}/properties/${parameters.propertyKey}`,
      method: 'GET',
    };
   ...
   * - **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:**
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg) or _Administer Projects_
   *   [project permission](https://confluence.atlassian.com/x/yodKLg) for the project in which the property is
   *   created.
   */
  async setProjectProperty(parameters: SetProjectPropertyParameters) {
    const request: Request = {
      url: `/rest/api/2/project/${parameters.projectIdOrKey}/properties/${parameters.propertyKey}`,
      method: 'PUT',
    };
