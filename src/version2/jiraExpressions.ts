...
import type { AnalyseExpressionParameters } from './parameters/analyseExpressionParameters';
import type { EvaluateJSISJiraExpressionParameters } from './parameters/evaluateJSISJiraExpressionParameters';
...
export class JiraExpressions {
   ...
   */
  async analyseExpression(parameters: AnalyseExpressionParameters) {
   ...
   */
  async evaluateJSISJiraExpression(parameters: EvaluateJSISJiraExpressionParameters) {
    const request: Request = {
