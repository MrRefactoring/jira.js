...
export class ProjectVersions {
  ...
  async createVersion<T = any>(callback?: Callback<T>): Promise<void>;
  async createVersion<T = any>(callback?: undefined): Promise<T>;
  async createVersion<T = any>(callback?: Callback<T>): Promise<void | T> {
    const config = ({
