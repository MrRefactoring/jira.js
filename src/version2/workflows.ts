...
export class Workflows {
   ...
   *   workflows](#api-rest-api-2-workflows-create-post) to create both team and company-managed scoped workflows.
   *
   ...
   *   workflows](#api-rest-api-2-workflows-search-get) instead.
   *
