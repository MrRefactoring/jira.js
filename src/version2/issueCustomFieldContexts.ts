...
import type { GetContextsForFieldParameters } from './parameters/getContextsForFieldParameters';
import type { CreateCustomFieldContextParameters } from './parameters/createCustomFieldContextParameters';
import type { GetDefaultValuesParameters } from './parameters/getDefaultValuesParameters';
import type { SetDefaultValuesParameters } from './parameters/setDefaultValuesParameters';
import type { GetIssueTypeMappingsForContextsParameters } from './parameters/getIssueTypeMappingsForContextsParameters';
import type { GetCustomFieldContextsForProjectsAndIssueTypesParameters } from './parameters/getCustomFieldContextsForProjectsAndIssueTypesParameters';
import type { GetProjectContextMappingParameters } from './parameters/getProjectContextMappingParameters';
import type { DeleteCustomFieldContextParameters } from './parameters/deleteCustomFieldContextParameters';
import type { UpdateCustomFieldContextParameters } from './parameters/updateCustomFieldContextParameters';
import type { AddIssueTypesToContextParameters } from './parameters/addIssueTypesToContextParameters';
import type { RemoveIssueTypesFromContextParameters } from './parameters/removeIssueTypesFromContextParameters';
import type { AssignProjectsToCustomFieldContextParameters } from './parameters/assignProjectsToCustomFieldContextParameters';
import type { RemoveCustomFieldContextFromProjectsParameters } from './parameters/removeCustomFieldContextFromProjectsParameters';
...
export class IssueCustomFieldContexts {
   ...
   */
  async getContextsForField(parameters: GetContextsForFieldParameters) {
   ...
   */
  async createCustomFieldContext(parameters: CreateCustomFieldContextParameters) {
    const request: Request = {
      url: `/rest/api/2/field/${parameters.fieldId}/context`,
      method: 'POST',
      body: {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async getDefaultValues(parameters: GetDefaultValuesParameters) {
    const request: Request = {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async setDefaultValues(parameters: SetDefaultValuesParameters) {
    const request: Request = {
      url: `/rest/api/2/field/${parameters.fieldId}/context/defaultValue`,
      method: 'PUT',
      body: {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async getIssueTypeMappingsForContexts(parameters: GetIssueTypeMappingsForContextsParameters) {
    const request: Request = {
  ...
  async getCustomFieldContextsForProjectsAndIssueTypes(
    parameters: GetCustomFieldContextsForProjectsAndIssueTypesParameters,
  ) {
    const request: Request = {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async getProjectContextMapping(parameters: GetProjectContextMappingParameters) {
    const request: Request = {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async deleteCustomFieldContext(parameters: DeleteCustomFieldContextParameters) {
    const request: Request = {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async updateCustomFieldContext(parameters: UpdateCustomFieldContextParameters) {
    const request: Request = {
      url: `/rest/api/2/field/${parameters.fieldId}/context/${parameters.contextId}`,
      method: 'PUT',
      body: {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async addIssueTypesToContext(parameters: AddIssueTypesToContextParameters) {
    const request: Request = {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async removeIssueTypesFromContext(parameters: RemoveIssueTypesFromContextParameters) {
    const request: Request = {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async assignProjectsToCustomFieldContext(parameters: AssignProjectsToCustomFieldContextParameters) {
    const request: Request = {
   ...
   *   _Administer Jira_ [global permission](https://confluence.atlassian.com/x/x4dKLg).
   */
  async removeCustomFieldContextFromProjects(parameters: RemoveCustomFieldContextFromProjectsParameters) {
    const request: Request = {
